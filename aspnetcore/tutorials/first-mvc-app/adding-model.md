...
Ejecute el comando siguiente de la CLI de .NET:

```dotnetcli
dotnet tool install --global dotnet-aspnet-codegenerator
```

El comando anterior agrega la [herramienta de scaffolding aspnet-codegenerator](xref:fundamentals/tools/dotnet-aspnet-codegenerator).
...
* Exporte la ruta de acceso de la herramienta de scaffolding:
