...
---
# <a name="part-6-add-search-to-aspnet-core-no-locrazor-pages"></a><span data-ttu-id="ba6ca-103">Parte 6. Adición de búsqueda a Razor Pages de ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="ba6ca-103">Part 6, add search to ASP.NET Core Razor Pages</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="ba6ca-153">Incorporación de búsqueda por género a una página de Razor</span><span class="sxs-lookup"><span data-stu-id="ba6ca-153">Add search by genre to the Razor Page</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="ba6ca-207">Incorporación de búsqueda por género a una página de Razor</span><span class="sxs-lookup"><span data-stu-id="ba6ca-207">Add search by genre to the Razor Page</span></span>
