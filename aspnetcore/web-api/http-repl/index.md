...
Para continuar, [vea o descargue la API web de muestra de ASP.NET Core ](https://github.com/dotnet/AspNetCore.Docs/tree/main/aspnetcore/web-api/http-repl/samples) ([cómo descargar](xref:index#how-to-download-a-sample)).
...
### <a name="manually-point-to-the-openapi-description-for-the-web-api"></a>Elección manual de la descripción de OpenAPI para la API web
...
### <a name="enable-verbose-output-for-details-on-openapi-description-searching-parsing-and-validation"></a>Habilitación de la salida detallada para obtener más información acerca de la búsqueda, el análisis y la validación de la descripción de OpenAPI
...
1. Salga de la herramienta y reiníciela antes de enviar otra solicitud a la API web.
 
### <a name="default-proxy-credentials"></a>Credenciales del proxy predeterminadas
