...
* <span data-ttu-id="29a84-107">Archivos de configuración, como *:::no-loc(appsettings.json):::*</span><span class="sxs-lookup"><span data-stu-id="29a84-107">Settings files, such as *:::no-loc(appsettings.json):::*</span></span>
...
1. <span data-ttu-id="29a84-123">[:::no-loc(appsettings.json):::](#appsettingsjson) con el proveedor de configuración [JSON](#file-configuration-provider).</span><span class="sxs-lookup"><span data-stu-id="29a84-123">[:::no-loc(appsettings.json):::](#appsettingsjson) using the [JSON configuration provider](#file-configuration-provider).</span></span>
...
<span data-ttu-id="29a84-129">Los proveedores de configuración que se agregan posteriormente invalidan los ajustes de configuración de la clave anteriores.</span><span class="sxs-lookup"><span data-stu-id="29a84-129">Configuration providers that are added later override previous key settings.</span></span> <span data-ttu-id="29a84-130">Por ejemplo, si `MyKey` se establece tanto en *:::no-loc(appsettings.json):::* como en el entorno, se usará el valor del entorno.</span><span class="sxs-lookup"><span data-stu-id="29a84-130">For example, if `MyKey` is set in both *:::no-loc(appsettings.json):::* and the environment, the environment value is used.</span></span> <span data-ttu-id="29a84-131">Con los proveedores de configuración predeterminados, el [proveedor de configuración de línea de comandos](#clcp) reemplaza al resto de proveedores.</span><span class="sxs-lookup"><span data-stu-id="29a84-131">Using the default configuration providers, the  [Command-line configuration provider](#clcp) overrides all other providers.</span></span>
...
<span data-ttu-id="29a84-134">Fíjese en el siguiente archivo *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="29a84-134">Consider the following *:::no-loc(appsettings.json):::* file:</span></span>
...
<span data-ttu-id="29a84-140">Los valores de *appsettings* .`Environment`. *json* invalidan las claves de *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="29a84-140">*appsettings* .`Environment`. *json* values override keys in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="29a84-141">Por ejemplo, de forma predeterminada:</span><span class="sxs-lookup"><span data-stu-id="29a84-141">For example, by default:</span></span>

* <span data-ttu-id="29a84-142">En el desarrollo, la configuración de *appsettings* .\* **Development** _._json\* sobrescribe los valores que se encuentran en *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="29a84-142">In development, *appsettings* .\* **Development** _._json\* configuration overwrites values found in *:::no-loc(appsettings.json):::* .</span></span>
* <span data-ttu-id="29a84-143">En la producción, la configuración de *appsettings* .\* **Production** _._json\* sobrescribe los valores que se encuentran en *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="29a84-143">In production, *appsettings* .\* **Production** _._json\* configuration overwrites values found in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="29a84-144">Por ejemplo, al implementar la aplicación en Azure.</span><span class="sxs-lookup"><span data-stu-id="29a84-144">For example, when deploying the app to Azure.</span></span>
...
<span data-ttu-id="29a84-146">Si usa la configuración [predeterminada](#default), los archivos *:::no-loc(appsettings.json):::* and *appsettings.* `Environment` *.json* están habilitados con [reloadOnChange: true](https://github.com/dotnet/extensions/blob/release/3.1/src/Hosting/Hosting/src/Host.cs#L74-L75).</span><span class="sxs-lookup"><span data-stu-id="29a84-146">Using the [default](#default) configuration, the *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* files are enabled with [reloadOnChange: true](https://github.com/dotnet/extensions/blob/release/3.1/src/Hosting/Hosting/src/Host.cs#L74-L75).</span></span> <span data-ttu-id="29a84-147">Los cambios realizados en los archivos *:::no-loc(appsettings.json):::* y *appsettings.* `Environment` *.json* \* **después** _ de iniciar la aplicación los lee el [proveedor de configuración JSON](#jcp).</span><span class="sxs-lookup"><span data-stu-id="29a84-147">Changes made to the *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* file \* **after** _ the app starts are read by the [JSON configuration provider](#jcp).</span></span>
...
<span data-ttu-id="29a84-156">De forma [predeterminada](#default), el [Administrador de secretos](xref:security/app-secrets) lee los ajustes de configuración después de los archivos *:::no-loc(appsettings.json):::* y *appsettings.* `Environment` *.json* .</span><span class="sxs-lookup"><span data-stu-id="29a84-156">By [default](#default), [Secret manager](xref:security/app-secrets) reads configuration settings after *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* .</span></span>
...
<span data-ttu-id="29a84-163">Al usar la configuración [predeterminada](#default), <xref:Microsoft.Extensions.Configuration.EnvironmentVariables.EnvironmentVariablesConfigurationProvider> carga la configuración de los pares clave-valor de la variable de entorno después de leer *:::no-loc(appsettings.json):::* , *appsettings.* `Environment` *.json* y el [Administrador de secretos](xref:security/app-secrets).</span><span class="sxs-lookup"><span data-stu-id="29a84-163">Using the [default](#default) configuration, the <xref:Microsoft.Extensions.Configuration.EnvironmentVariables.EnvironmentVariablesConfigurationProvider> loads configuration from environment variable key-value pairs after reading *:::no-loc(appsettings.json):::* , *appsettings.*`Environment`*.json* , and [Secret manager](xref:security/app-secrets).</span></span> <span data-ttu-id="29a84-164">Por lo tanto, los valores de clave que se leen del entorno reemplazan los valores que se leen de *:::no-loc(appsettings.json):::* , *appsettings.* `Environment` *.json* y del Administrador de secretos.</span><span class="sxs-lookup"><span data-stu-id="29a84-164">Therefore, key values read from the environment override values read from *:::no-loc(appsettings.json):::* , *appsettings.*`Environment`*.json* , and Secret manager.</span></span>
...
<span data-ttu-id="29a84-176">Para comprobar que los comandos anteriores invalidan *:::no-loc(appsettings.json):::* y *appsettings.* `Environment` *.json* :</span><span class="sxs-lookup"><span data-stu-id="29a84-176">To test that the preceding commands override *:::no-loc(appsettings.json):::* and *appsettings.*`Environment`*.json* :</span></span>
...
* <span data-ttu-id="29a84-200">Los archivos *:::no-loc(appsettings.json):::* y *appsettings* .`Environment`. *json* .</span><span class="sxs-lookup"><span data-stu-id="29a84-200">*:::no-loc(appsettings.json):::* and *appsettings* .`Environment`. *json* files.</span></span>
...
<span data-ttu-id="29a84-230">La [descarga de ejemplo](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/fundamentals/configuration/index/samples/3.x/ConfigSample) contiene el siguiente archivo *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="29a84-230">The [sample download](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/fundamentals/configuration/index/samples/3.x/ConfigSample) contains the following  *:::no-loc(appsettings.json):::* file:</span></span>
...
* <span data-ttu-id="29a84-336">Invalida la configuración de los archivos *:::no-loc(appsettings.json):::* y *appsettings* .`Environment`. *json* .</span><span class="sxs-lookup"><span data-stu-id="29a84-336">Override settings in the *:::no-loc(appsettings.json):::* and *appsettings* .`Environment`. *json* files.</span></span>
...
## <a name="access-configuration-in-no-locrazor-pages"></a><span data-ttu-id="29a84-437">Acceso a la configuración en :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="29a84-437">Access configuration in :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="29a84-438">En el código siguiente se muestran los datos de configuración en una página de :::no-loc(Razor):::Pages:</span><span class="sxs-lookup"><span data-stu-id="29a84-438">The following code displays configuration data in a :::no-loc(Razor)::: Page:</span></span>
...
* <span data-ttu-id="29a84-520">La configuración de la aplicación la proporcionan los siguientes elementos:</span><span class="sxs-lookup"><span data-stu-id="29a84-520">App configuration is provided from:</span></span>
  * <span data-ttu-id="29a84-521">*:::no-loc(appsettings.json):::* con el [proveedor de configuración de archivo](#file-configuration-provider).</span><span class="sxs-lookup"><span data-stu-id="29a84-521">*:::no-loc(appsettings.json):::* using the [File Configuration Provider](#file-configuration-provider).</span></span>
...
<span data-ttu-id="29a84-553"><xref:Microsoft.Extensions.Configuration.IConfiguration> está disponible en el contenedor de [inserción de dependencias (DI)](xref:fundamentals/dependency-injection) de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="29a84-553"><xref:Microsoft.Extensions.Configuration.IConfiguration> is available in the app's [dependency injection (DI)](xref:fundamentals/dependency-injection) container.</span></span> <span data-ttu-id="29a84-554"><xref:Microsoft.Extensions.Configuration.IConfiguration> se puede insertar en :::no-loc(Razor)::: Pages <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> o MVC <xref:Microsoft.AspNetCore.Mvc.Controller> para obtener la configuración de la clase.</span><span class="sxs-lookup"><span data-stu-id="29a84-554"><xref:Microsoft.Extensions.Configuration.IConfiguration> can be injected into a :::no-loc(Razor)::: Pages <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> or MVC <xref:Microsoft.AspNetCore.Mvc.Controller> to obtain configuration for the class.</span></span>
...
1. <span data-ttu-id="29a84-601">Archivos ( *:::no-loc(appsettings.json):::* y *appsettings.{Environment}.json* , donde `{Environment}` es el entorno de hospedaje actual de la aplicación)</span><span class="sxs-lookup"><span data-stu-id="29a84-601">Files ( *:::no-loc(appsettings.json):::* , *appsettings.{Environment}.json* , where `{Environment}` is the app's current hosting environment)</span></span>
...
* <span data-ttu-id="29a84-626">Configuración opcional de los archivos *:::no-loc(appsettings.json):::* y *appsettings.{Environment}.json* .</span><span class="sxs-lookup"><span data-stu-id="29a84-626">Optional configuration from *:::no-loc(appsettings.json):::* and *appsettings.{Environment}.json* files.</span></span>
...
* <span data-ttu-id="29a84-684">Configuración opcional de los archivos *:::no-loc(appsettings.json):::* y *appsettings.{Environment}.json* .</span><span class="sxs-lookup"><span data-stu-id="29a84-684">Optional configuration from *:::no-loc(appsettings.json):::* and *appsettings.{Environment}.json* files.</span></span>
...
* <span data-ttu-id="29a84-764">*:::no-loc(appsettings.json):::* : Este archivo se lee primero.</span><span class="sxs-lookup"><span data-stu-id="29a84-764">*:::no-loc(appsettings.json):::* : This file is read first.</span></span> <span data-ttu-id="29a84-765">La versión del entorno del archivo puede invalidar los valores que proporciona el archivo *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="29a84-765">The environment version of the file can override the values provided by the *:::no-loc(appsettings.json):::* file.</span></span>
...
* <span data-ttu-id="29a84-777">La primera llamada a `AddJsonFile` carga la configuración desde *:::no-loc(appsettings.json):::* :</span><span class="sxs-lookup"><span data-stu-id="29a84-777">The first call to `AddJsonFile` loads configuration from *:::no-loc(appsettings.json):::* :</span></span>
...
1. <span data-ttu-id="29a84-788">La configuración de *appsettings.Development.json* ya no invalida la configuración de *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="29a84-788">The settings in the *appsettings.Development.json* no longer override the settings in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="29a84-789">El nivel de registro de la clave `Logging:LogLevel:Default` es `Warning`.</span><span class="sxs-lookup"><span data-stu-id="29a84-789">The log level for the key `Logging:LogLevel:Default` is `Warning`.</span></span>
...
## <a name="access-configuration-in-a-no-locrazor-pages-page-or-mvc-view"></a><span data-ttu-id="29a84-995">Acceso a la configuración en una página de :::no-loc(Razor)::: Pages o en una vista de MVC</span><span class="sxs-lookup"><span data-stu-id="29a84-995">Access configuration in a :::no-loc(Razor)::: Pages page or MVC view</span></span>

<span data-ttu-id="29a84-996">Para acceder a los valores de configuración en una página de :::no-loc(Razor)::: Pages o una vista de MVC, agregue una [directiva using](xref:mvc/views/razor#using) ([Referencia de C#: directiva using](/dotnet/csharp/language-reference/keywords/using-directive)) para el [espacio de nombres Microsoft.Extensions.Configuration](xref:Microsoft.Extensions.Configuration) e inyecte <xref:Microsoft.Extensions.Configuration.IConfiguration> en la página o en la vista.</span><span class="sxs-lookup"><span data-stu-id="29a84-996">To access configuration settings in a :::no-loc(Razor)::: Pages page or an MVC view, add a [using directive](xref:mvc/views/razor#using) ([C# reference: using directive](/dotnet/csharp/language-reference/keywords/using-directive)) for the [Microsoft.Extensions.Configuration namespace](xref:Microsoft.Extensions.Configuration) and inject <xref:Microsoft.Extensions.Configuration.IConfiguration> into the page or view.</span></span>

<span data-ttu-id="29a84-997">En una página de :::no-loc(Razor)::: Pages:</span><span class="sxs-lookup"><span data-stu-id="29a84-997">In a :::no-loc(Razor)::: Pages page:</span></span>
