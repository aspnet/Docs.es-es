...
---
# <a name="introduction-to-no-locrazor-pages-in-aspnet-core"></a><span data-ttu-id="1bb00-103">Introducción a :::no-loc(Razor)::: Pages en ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="1bb00-103">Introduction to :::no-loc(Razor)::: Pages in ASP.NET Core</span></span>
...
<span data-ttu-id="1bb00-105">:::no-loc(Razor)::: Pages facilita la programación de escenarios centrados en páginas y hace que resulte más productiva que con controladores y vistas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-105">:::no-loc(Razor)::: Pages can make coding page-focused scenarios easier and more productive than using controllers and views.</span></span>
...
<span data-ttu-id="1bb00-107">En este documento se proporciona una introducción a :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-107">This document provides an introduction to :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="1bb00-108">No es un tutorial paso a paso.</span><span class="sxs-lookup"><span data-stu-id="1bb00-108">It's not a step by step tutorial.</span></span> <span data-ttu-id="1bb00-109">Si encuentra que alguna sección es demasiado avanzada, consulte [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start).</span><span class="sxs-lookup"><span data-stu-id="1bb00-109">If you find some of the sections too advanced, see [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start).</span></span> <span data-ttu-id="1bb00-110">Para obtener información general de ASP.NET Core, vea [Introducción a ASP.NET Core](xref:index).</span><span class="sxs-lookup"><span data-stu-id="1bb00-110">For an overview of ASP.NET Core, see the [Introduction to ASP.NET Core](xref:index).</span></span>
...
## <a name="create-a-no-locrazor-pages-project"></a><span data-ttu-id="1bb00-115">Crear un proyecto de :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-115">Create a :::no-loc(Razor)::: Pages project</span></span>
...
<span data-ttu-id="1bb00-121">Vea [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) para obtener instrucciones detalladas sobre cómo crear un proyecto :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-121">See [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) for detailed instructions on how to create a :::no-loc(Razor)::: Pages project.</span></span>

---

## <a name="no-locrazor-pages"></a><span data-ttu-id="1bb00-122">:::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-122">:::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-123">:::no-loc(Razor)::: Pages está habilitado en *Startup.cs* :</span><span class="sxs-lookup"><span data-stu-id="1bb00-123">:::no-loc(Razor)::: Pages is enabled in *Startup.cs* :</span></span>
...
<span data-ttu-id="1bb00-125">El código anterior se parece mucho a un [archivo de vista de :::no-loc(Razor):::](xref:tutorials/first-mvc-app/adding-view) que se utiliza en una aplicación ASP.NET Core con controladores y vistas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-125">The preceding code looks a lot like a [:::no-loc(Razor)::: view file](xref:tutorials/first-mvc-app/adding-view) used in an ASP.NET Core app with controllers and views.</span></span> <span data-ttu-id="1bb00-126">La directiva [`@page`](xref:mvc/views/razor#page) lo hace diferente.</span><span class="sxs-lookup"><span data-stu-id="1bb00-126">What makes it different is the [`@page`](xref:mvc/views/razor#page) directive.</span></span> <span data-ttu-id="1bb00-127">`@page` transforma el archivo en una acción de MVC, lo que significa que administra las solicitudes directamente, sin tener que pasar a través de un controlador.</span><span class="sxs-lookup"><span data-stu-id="1bb00-127">`@page` makes the file into an MVC action - which means that it handles requests directly, without going through a controller.</span></span> <span data-ttu-id="1bb00-128">`@page` debe ser la primera directiva de :::no-loc(Razor):::de una página.</span><span class="sxs-lookup"><span data-stu-id="1bb00-128">`@page` must be the first :::no-loc(Razor)::: directive on a page.</span></span> <span data-ttu-id="1bb00-129">`@page` afecta al comportamiento de otras construcciones de [:::no-loc(Razor):::](xref:mvc/views/razor).</span><span class="sxs-lookup"><span data-stu-id="1bb00-129">`@page` affects the behavior of other [:::no-loc(Razor):::](xref:mvc/views/razor) constructs.</span></span> <span data-ttu-id="1bb00-130">Los nombres de archivo de :::no-loc(Razor)::: Pages tienen el sufijo *.cshtml*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-130">:::no-loc(Razor)::: Pages file names have a *.cshtml* suffix.</span></span>
...
<span data-ttu-id="1bb00-134">Por convención, el archivo de clase `PageModel` tiene el mismo nombre que el archivo de :::no-loc(Razor)::: Pages con *.cs* anexado.</span><span class="sxs-lookup"><span data-stu-id="1bb00-134">By convention, the `PageModel` class file has the same name as the :::no-loc(Razor)::: Page file with *.cs* appended.</span></span> <span data-ttu-id="1bb00-135">Por ejemplo, la instancia de :::no-loc(Razor)::: Pages anterior es *Pages/Index2.cshtml*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-135">For example, the previous :::no-loc(Razor)::: Page is *Pages/Index2.cshtml*.</span></span> <span data-ttu-id="1bb00-136">El archivo que contiene la clase `PageModel` se denomina *Pages/Index2.cshtml.cs*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-136">The file containing the `PageModel` class is named *Pages/Index2.cshtml.cs*.</span></span>
...
* <span data-ttu-id="1bb00-148">El entorno de ejecución busca archivos de páginas de :::no-loc(Razor)::: en la carpeta *Pages* de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="1bb00-148">The runtime looks for :::no-loc(Razor)::: Pages files in the *Pages* folder by default.</span></span>
...
<span data-ttu-id="1bb00-151">:::no-loc(Razor)::: Pages está diseñado para facilitar la implementación de patrones comunes que se usan con exploradores web al compilar una aplicación.</span><span class="sxs-lookup"><span data-stu-id="1bb00-151">:::no-loc(Razor)::: Pages is designed to make common patterns used with web browsers easy to implement when building an app.</span></span> <span data-ttu-id="1bb00-152">Los [enlaces de modelos](xref:mvc/models/model-binding), los [asistentes de etiquetas](xref:mvc/views/tag-helpers/intro) y los asistentes de HTML *simplemente funcionan* con las propiedades definidas en una clase de :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-152">[Model binding](xref:mvc/models/model-binding), [Tag Helpers](xref:mvc/views/tag-helpers/intro), and HTML helpers all *just work* with the properties defined in a :::no-loc(Razor)::: Page class.</span></span> <span data-ttu-id="1bb00-153">Considere la posibilidad de una página que implementa un formulario básico del estilo "Póngase en contacto con nosotros" para el modelo `Contact`:</span><span class="sxs-lookup"><span data-stu-id="1bb00-153">Consider a page that implements a basic "contact us" form for the `Contact` model:</span></span>

<span data-ttu-id="1bb00-154">Para los ejemplos de este documento, `DbContext` se inicializa en el archivo [Startup.cs](https://github.com/dotnet/AspNetCore.Docs/blob/master/aspnetcore/razor-pages/index/3.0sample/:::no-loc(Razor):::PagesContacts/Startup.cs#L23-L24).</span><span class="sxs-lookup"><span data-stu-id="1bb00-154">For the samples in this document, the `DbContext` is initialized in the [Startup.cs](https://github.com/dotnet/AspNetCore.Docs/blob/master/aspnetcore/razor-pages/index/3.0sample/:::no-loc(Razor):::PagesContacts/Startup.cs#L23-L24) file.</span></span>
...
<span data-ttu-id="1bb00-172">El sufijo de nombre `Async` es opcional, pero se usa a menudo por convención para funciones asincrónicas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-172">The `Async` naming suffix is optional but is often used by convention for asynchronous functions.</span></span> <span data-ttu-id="1bb00-173">El código anterior es típico de :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-173">The preceding code is typical for :::no-loc(Razor)::: Pages.</span></span>
...
* <span data-ttu-id="1bb00-186">Con datos válidos:</span><span class="sxs-lookup"><span data-stu-id="1bb00-186">With valid data:</span></span>
  ...
  * <span data-ttu-id="1bb00-187">El método del controlador `OnPostAsync` llama al método auxiliar <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.RedirectToPage*>.</span><span class="sxs-lookup"><span data-stu-id="1bb00-187">The `OnPostAsync` handler method calls the <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.RedirectToPage*> helper method.</span></span> <span data-ttu-id="1bb00-188">`RedirectToPage` devuelve una instancia de <xref:Microsoft.AspNetCore.Mvc.RedirectToPageResult>.</span><span class="sxs-lookup"><span data-stu-id="1bb00-188">`RedirectToPage` returns an instance of <xref:Microsoft.AspNetCore.Mvc.RedirectToPageResult>.</span></span> <span data-ttu-id="1bb00-189">`RedirectToPage`:</span><span class="sxs-lookup"><span data-stu-id="1bb00-189">`RedirectToPage`:</span></span>
...
* <span data-ttu-id="1bb00-195">Con errores de validación que se pasan al servidor:</span><span class="sxs-lookup"><span data-stu-id="1bb00-195">With validation errors that are passed to the server:</span></span>
  ...
  * <span data-ttu-id="1bb00-196">El método del controlador `OnPostAsync` llama al método auxiliar <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageBase.Page*>.</span><span class="sxs-lookup"><span data-stu-id="1bb00-196">The `OnPostAsync` handler method calls the <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageBase.Page*> helper method.</span></span> <span data-ttu-id="1bb00-197">`Page` devuelve una instancia de <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageResult>.</span><span class="sxs-lookup"><span data-stu-id="1bb00-197">`Page` returns an instance of <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageResult>.</span></span> <span data-ttu-id="1bb00-198">Devolver `Page` es similar a cómo las acciones en los controladores devuelven `View`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-198">Returning `Page` is similar to how actions in controllers return `View`.</span></span> <span data-ttu-id="1bb00-199">`PageResult` es el tipo de valor devuelto predeterminado para un método de controlador.</span><span class="sxs-lookup"><span data-stu-id="1bb00-199">`PageResult` is the default return type for a handler method.</span></span> <span data-ttu-id="1bb00-200">Un método de controlador que devuelve `void` representa la página.</span><span class="sxs-lookup"><span data-stu-id="1bb00-200">A handler method that returns `void` renders the page.</span></span>
...
* <span data-ttu-id="1bb00-237">Llama a <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.RedirectToPage*> para redirigir la página Index raíz (`/Index`).</span><span class="sxs-lookup"><span data-stu-id="1bb00-237">Calls <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.RedirectToPage*> to redirect to the root Index page (`/Index`).</span></span>
...
<span data-ttu-id="1bb00-291">:::no-loc(Razor)::: Pages recurre a una llamada al controlador `OnGet` si no se define ningún controlador `OnHead`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-291">:::no-loc(Razor)::: Pages falls back to calling the `OnGet` handler if no `OnHead` handler is defined.</span></span>

<a name="xsrf"></a>

## <a name="xsrfcsrf-and-no-locrazor-pages"></a><span data-ttu-id="1bb00-292">XSRF/CSRF y :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-292">XSRF/CSRF and :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-293">:::no-loc(Razor)::: Pages está protegido mediante [validación antifalsificación](xref:security/anti-request-forgery).</span><span class="sxs-lookup"><span data-stu-id="1bb00-293">:::no-loc(Razor)::: Pages are protected by [Antiforgery validation](xref:security/anti-request-forgery).</span></span> <span data-ttu-id="1bb00-294">El elemento [FormTagHelper](xref:mvc/views/working-with-forms#the-form-tag-helper) inserta tokens antifalsificación en los elementos de formulario HTML.</span><span class="sxs-lookup"><span data-stu-id="1bb00-294">The [FormTagHelper](xref:mvc/views/working-with-forms#the-form-tag-helper) injects antiforgery tokens into HTML form elements.</span></span>

<a name="layout"></a>

## <a name="using-layouts-partials-templates-and-tag-helpers-with-no-locrazor-pages"></a><span data-ttu-id="1bb00-295">Usar diseños, parciales, plantillas y asistentes de etiquetas con :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-295">Using Layouts, partials, templates, and Tag Helpers with :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-296">Las páginas funcionan con todas las características del motor de vista de :::no-loc(Razor):::.</span><span class="sxs-lookup"><span data-stu-id="1bb00-296">Pages work with all the capabilities of the :::no-loc(Razor)::: view engine.</span></span> <span data-ttu-id="1bb00-297">Los diseños, parciales, plantillas, asistentes de etiquetas, *_ViewStart.cshtml* y *_ViewImports.cshtml* funcionan de la misma manera que lo hacen con las vistas de :::no-loc(Razor)::: convencionales.</span><span class="sxs-lookup"><span data-stu-id="1bb00-297">Layouts, partials, templates, Tag Helpers, *_ViewStart.cshtml* , and *_ViewImports.cshtml* work in the same way they do for conventional :::no-loc(Razor)::: views.</span></span>
...
* <span data-ttu-id="1bb00-303">El contenido de la página de :::no-loc(Razor)::: se representa donde se llama a `@RenderBody()`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-303">The contents of the :::no-loc(Razor)::: page are rendered where `@RenderBody()` is called.</span></span>
...
<span data-ttu-id="1bb00-306">El diseño está en la carpeta *Pages/Shared*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-306">The layout is in the *Pages/Shared* folder.</span></span> <span data-ttu-id="1bb00-307">Las páginas buscan otras vistas (diseños, plantillas, parciales) de forma jerárquica, a partir de la misma carpeta que la página actual.</span><span class="sxs-lookup"><span data-stu-id="1bb00-307">Pages look for other views (layouts, templates, partials) hierarchically, starting in the same folder as the current page.</span></span> <span data-ttu-id="1bb00-308">Un diseño en la carpeta *Pages/Shared* se puede usar desde cualquier página de :::no-loc(Razor)::: en la carpeta *Pages*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-308">A layout in the *Pages/Shared* folder can be used from any :::no-loc(Razor)::: page under the *Pages* folder.</span></span>
...
<span data-ttu-id="1bb00-310">Le recomendamos que **no** coloque el archivo de diseño en la carpeta *Views/Shared*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-310">We recommend you **not** put the layout file in the *Views/Shared* folder.</span></span> <span data-ttu-id="1bb00-311">*Views/Shared* es un patrón de vistas de MVC.</span><span class="sxs-lookup"><span data-stu-id="1bb00-311">*Views/Shared* is an MVC views pattern.</span></span> <span data-ttu-id="1bb00-312">:::no-loc(Razor)::: Pages está diseñado para basarse en la jerarquía de carpetas, no en las convenciones de ruta de acceso.</span><span class="sxs-lookup"><span data-stu-id="1bb00-312">:::no-loc(Razor)::: Pages are meant to rely on folder hierarchy, not path conventions.</span></span>

<span data-ttu-id="1bb00-313">La búsqueda de vistas de una instancia de :::no-loc(Razor)::: Pages incluye la carpeta *Pages*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-313">View search from a :::no-loc(Razor)::: Page includes the *Pages* folder.</span></span> <span data-ttu-id="1bb00-314">Los diseños, plantillas y parciales que se usan con los controladores de MVC y las vistas de :::no-loc(Razor)::: convencionales *simplemente funcionan*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-314">The layouts, templates, and partials used with MVC controllers and conventional :::no-loc(Razor)::: views *just work*.</span></span>
...
<span data-ttu-id="1bb00-325">El espacio de nombres generado para la página de :::no-loc(Razor)::: *Pages/Customers/Edit.cshtml* es el mismo que la clase `PageModel`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-325">The generated namespace for the *Pages/Customers/Edit.cshtml* :::no-loc(Razor)::: Page is the same as the `PageModel` class.</span></span>

<span data-ttu-id="1bb00-326">`@namespace` *también funciona con vistas de :::no-loc(Razor)::: convencionales.*</span><span class="sxs-lookup"><span data-stu-id="1bb00-326">`@namespace` *also works with conventional :::no-loc(Razor)::: views.*</span></span>
...
<span data-ttu-id="1bb00-331">El [proyecto de inicio de :::no-loc(Razor)::: Pages](#rpvs17) contiene *Pages/_ValidationScriptsPartial.cshtml* , que enlaza la validación del lado cliente.</span><span class="sxs-lookup"><span data-stu-id="1bb00-331">The [:::no-loc(Razor)::: Pages starter project](#rpvs17) contains the *Pages/_ValidationScriptsPartial.cshtml* , which hooks up client-side validation.</span></span>
...
<span data-ttu-id="1bb00-417">Para configurar las opciones avanzadas, use la sobrecarga <xref:Microsoft.Extensions.DependencyInjection.MvcServiceCollectionExtensions.Add:::no-loc(Razor):::Pages%2A> que configura <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.:::no-loc(Razor):::PagesOptions>:</span><span class="sxs-lookup"><span data-stu-id="1bb00-417">To configure advanced options, use the <xref:Microsoft.Extensions.DependencyInjection.MvcServiceCollectionExtensions.Add:::no-loc(Razor):::Pages%2A> overload that configures <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.:::no-loc(Razor):::PagesOptions>:</span></span>

[!code-csharp[](index/3.0sample/:::no-loc(Razor):::PagesContacts/StartupRPoptions.cs?name=snippet)]

<span data-ttu-id="1bb00-418">Use el elemento <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.:::no-loc(Razor):::PagesOptions> para establecer el directorio raíz de páginas o agregar convenciones de modelo de aplicación para las páginas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-418">Use the <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.:::no-loc(Razor):::PagesOptions> to set the root directory for pages, or add application model conventions for pages.</span></span> <span data-ttu-id="1bb00-419">Para obtener más información sobre las convenciones, vea [Convenciones de autorización de :::no-loc(Razor)::: Pages](xref:security/authorization/razor-pages-authorization).</span><span class="sxs-lookup"><span data-stu-id="1bb00-419">For more information on conventions, see [:::no-loc(Razor)::: Pages authorization conventions](xref:security/authorization/razor-pages-authorization).</span></span>

<span data-ttu-id="1bb00-420">Para precompilar vistas, consulte la sección sobre la [compilación de vistas de :::no-loc(Razor):::](xref:mvc/views/view-compilation).</span><span class="sxs-lookup"><span data-stu-id="1bb00-420">To precompile views, see [:::no-loc(Razor)::: view compilation](xref:mvc/views/view-compilation).</span></span>

### <a name="specify-that-no-locrazor-pages-are-at-the-content-root"></a><span data-ttu-id="1bb00-421">Especificación de :::no-loc(Razor)::: Pages en la raíz del contenido</span><span class="sxs-lookup"><span data-stu-id="1bb00-421">Specify that :::no-loc(Razor)::: Pages are at the content root</span></span>

<span data-ttu-id="1bb00-422">De forma predeterminada, :::no-loc(Razor)::: Pages se encuentra en la raíz del directorio */Pages*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-422">By default, :::no-loc(Razor)::: Pages are rooted in the */Pages* directory.</span></span> <span data-ttu-id="1bb00-423">Agregue <xref:Microsoft.Extensions.DependencyInjection.Mvc:::no-loc(Razor):::PagesMvcBuilderExtensions.With:::no-loc(Razor):::PagesAtContentRoot*> para especificar que sus instancias de :::no-loc(Razor)::: Pages se encuentran en la [raíz de contenido](xref:fundamentals/index#content-root) (<xref:Microsoft.AspNetCore.Hosting.IHostingEnvironment.ContentRootPath>) de la aplicación:</span><span class="sxs-lookup"><span data-stu-id="1bb00-423">Add <xref:Microsoft.Extensions.DependencyInjection.Mvc:::no-loc(Razor):::PagesMvcBuilderExtensions.With:::no-loc(Razor):::PagesAtContentRoot*> to specify that your :::no-loc(Razor)::: Pages are at the [content root](xref:fundamentals/index#content-root) (<xref:Microsoft.AspNetCore.Hosting.IHostingEnvironment.ContentRootPath>) of the app:</span></span>

[!code-csharp[](index/3.0sample/:::no-loc(Razor):::PagesContacts/StartupWith:::no-loc(Razor):::PagesAtContentRoot.cs?name=snippet)]

### <a name="specify-that-no-locrazor-pages-are-at-a-custom-root-directory"></a><span data-ttu-id="1bb00-424">Especificación de :::no-loc(Razor)::: Pages en un directorio raíz personalizado</span><span class="sxs-lookup"><span data-stu-id="1bb00-424">Specify that :::no-loc(Razor)::: Pages are at a custom root directory</span></span>

<span data-ttu-id="1bb00-425">Agregue <xref:Microsoft.Extensions.DependencyInjection.Mvc:::no-loc(Razor):::PagesMvcCoreBuilderExtensions.With:::no-loc(Razor):::PagesRoot*> para especificar que :::no-loc(Razor)::: Pages se encuentra en un directorio raíz personalizado en la aplicación (proporcione una ruta de acceso relativa):</span><span class="sxs-lookup"><span data-stu-id="1bb00-425">Add <xref:Microsoft.Extensions.DependencyInjection.Mvc:::no-loc(Razor):::PagesMvcCoreBuilderExtensions.With:::no-loc(Razor):::PagesRoot*> to specify that :::no-loc(Razor)::: Pages are at a custom root directory in the app (provide a relative path):</span></span>
...
* <span data-ttu-id="1bb00-427">Consulte [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start), que se basa en esta introducción.</span><span class="sxs-lookup"><span data-stu-id="1bb00-427">See [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start), which builds on this introduction.</span></span>
* [<span data-ttu-id="1bb00-428">Autorización de atributos y :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-428">Authorize attribute and :::no-loc(Razor)::: Pages</span></span>](xref:security/authorization/simple#aarp)
...
<span data-ttu-id="1bb00-431">:::no-loc(Razor):::Pages es una nueva característica de ASP.NET Core MVC que facilita la codificación de escenarios centrados en páginas y hace que sea más productiva.</span><span class="sxs-lookup"><span data-stu-id="1bb00-431">:::no-loc(Razor)::: Pages is a new aspect of ASP.NET Core MVC that makes coding page-focused scenarios easier and more productive.</span></span>
...
<span data-ttu-id="1bb00-433">En este documento se proporciona una introducción a :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-433">This document provides an introduction to :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="1bb00-434">No es un tutorial paso a paso.</span><span class="sxs-lookup"><span data-stu-id="1bb00-434">It's not a step by step tutorial.</span></span> <span data-ttu-id="1bb00-435">Si encuentra que alguna sección es demasiado avanzada, consulte [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start).</span><span class="sxs-lookup"><span data-stu-id="1bb00-435">If you find some of the sections too advanced, see [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start).</span></span> <span data-ttu-id="1bb00-436">Para obtener información general de ASP.NET Core, vea [Introducción a ASP.NET Core](xref:index).</span><span class="sxs-lookup"><span data-stu-id="1bb00-436">For an overview of ASP.NET Core, see the [Introduction to ASP.NET Core](xref:index).</span></span>
...
## <a name="create-a-no-locrazor-pages-project"></a><span data-ttu-id="1bb00-441">Crear un proyecto de :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-441">Create a :::no-loc(Razor)::: Pages project</span></span>
...
<span data-ttu-id="1bb00-443">Vea [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) para obtener instrucciones detalladas sobre cómo crear un proyecto :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-443">See [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) for detailed instructions on how to create a :::no-loc(Razor)::: Pages project.</span></span>
...
## <a name="no-locrazor-pages"></a><span data-ttu-id="1bb00-449">:::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-449">:::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-450">:::no-loc(Razor)::: Pages está habilitado en *Startup.cs* :</span><span class="sxs-lookup"><span data-stu-id="1bb00-450">:::no-loc(Razor)::: Pages is enabled in *Startup.cs* :</span></span>
...
<span data-ttu-id="1bb00-452">El código anterior se parece mucho a un [archivo de vista de :::no-loc(Razor):::](xref:tutorials/first-mvc-app/adding-view) que se utiliza en una aplicación ASP.NET Core con controladores y vistas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-452">The preceding code looks a lot like a [:::no-loc(Razor)::: view file](xref:tutorials/first-mvc-app/adding-view) used in an ASP.NET Core app with controllers and views.</span></span> <span data-ttu-id="1bb00-453">La directiva `@page` lo hace diferente.</span><span class="sxs-lookup"><span data-stu-id="1bb00-453">What makes it different is the `@page` directive.</span></span> <span data-ttu-id="1bb00-454">`@page` transforma el archivo en una acción de MVC, lo que significa que administra las solicitudes directamente, sin tener que pasar a través de un controlador.</span><span class="sxs-lookup"><span data-stu-id="1bb00-454">`@page` makes the file into an MVC action - which means that it handles requests directly, without going through a controller.</span></span> <span data-ttu-id="1bb00-455">`@page` debe ser la primera directiva de :::no-loc(Razor)::: de una página.</span><span class="sxs-lookup"><span data-stu-id="1bb00-455">`@page` must be the first :::no-loc(Razor)::: directive on a page.</span></span> <span data-ttu-id="1bb00-456">`@page` afecta al comportamiento de otras construcciones de :::no-loc(Razor):::.</span><span class="sxs-lookup"><span data-stu-id="1bb00-456">`@page` affects the behavior of other :::no-loc(Razor)::: constructs.</span></span>
...
<span data-ttu-id="1bb00-460">Por convención, el archivo de clase `PageModel` tiene el mismo nombre que el archivo de :::no-loc(Razor)::: Pages con *.cs* anexado.</span><span class="sxs-lookup"><span data-stu-id="1bb00-460">By convention, the `PageModel` class file has the same name as the :::no-loc(Razor)::: Page file with *.cs* appended.</span></span> <span data-ttu-id="1bb00-461">Por ejemplo, la instancia de :::no-loc(Razor)::: Pages anterior es *Pages/Index2.cshtml*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-461">For example, the previous :::no-loc(Razor)::: Page is *Pages/Index2.cshtml*.</span></span> <span data-ttu-id="1bb00-462">El archivo que contiene la clase `PageModel` se denomina *Pages/Index2.cshtml.cs*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-462">The file containing the `PageModel` class is named *Pages/Index2.cshtml.cs*.</span></span>
...
* <span data-ttu-id="1bb00-474">El entorno de ejecución busca archivos de páginas de :::no-loc(Razor)::: en la carpeta *Pages* de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="1bb00-474">The runtime looks for :::no-loc(Razor)::: Pages files in the *Pages* folder by default.</span></span>
...
<span data-ttu-id="1bb00-477">:::no-loc(Razor)::: Pages está diseñado para facilitar la implementación de patrones comunes que se usan con exploradores web al compilar una aplicación.</span><span class="sxs-lookup"><span data-stu-id="1bb00-477">:::no-loc(Razor)::: Pages is designed to make common patterns used with web browsers easy to implement when building an app.</span></span> <span data-ttu-id="1bb00-478">Los [enlaces de modelos](xref:mvc/models/model-binding), los [asistentes de etiquetas](xref:mvc/views/tag-helpers/intro) y los asistentes de HTML *simplemente funcionan* con las propiedades definidas en una clase de :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-478">[Model binding](xref:mvc/models/model-binding), [Tag Helpers](xref:mvc/views/tag-helpers/intro), and HTML helpers all *just work* with the properties defined in a :::no-loc(Razor)::: Page class.</span></span> <span data-ttu-id="1bb00-479">Considere la posibilidad de una página que implementa un formulario básico del estilo "Póngase en contacto con nosotros" para el modelo `Contact`:</span><span class="sxs-lookup"><span data-stu-id="1bb00-479">Consider a page that implements a basic "contact us" form for the `Contact` model:</span></span>

<span data-ttu-id="1bb00-480">Para los ejemplos de este documento, `DbContext` se inicializa en el archivo [Startup.cs](https://github.com/dotnet/AspNetCore.Docs/blob/master/aspnetcore/razor-pages/index/sample/:::no-loc(Razor):::PagesContacts/Startup.cs#L15-L16).</span><span class="sxs-lookup"><span data-stu-id="1bb00-480">For the samples in this document, the `DbContext` is initialized in the [Startup.cs](https://github.com/dotnet/AspNetCore.Docs/blob/master/aspnetcore/razor-pages/index/sample/:::no-loc(Razor):::PagesContacts/Startup.cs#L15-L16) file.</span></span>
...
<span data-ttu-id="1bb00-497">El sufijo de nombre `Async` es opcional, pero se usa a menudo por convención para funciones asincrónicas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-497">The `Async` naming suffix is optional but is often used by convention for asynchronous functions.</span></span> <span data-ttu-id="1bb00-498">El código anterior es típico de :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-498">The preceding code is typical for :::no-loc(Razor)::: Pages.</span></span>
...
<span data-ttu-id="1bb00-561">En ASP.NET Core 2.1 o versiones posteriores, :::no-loc(Razor)::: Pages recurre a una llamada al controlador `OnGet` si no se define ningún controlador `OnHead`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-561">In ASP.NET Core 2.1 or later, :::no-loc(Razor)::: Pages falls back to calling the `OnGet` handler if no `OnHead` handler is defined.</span></span> <span data-ttu-id="1bb00-562">Este comportamiento se habilita mediante la llamada a [SetCompatibilityVersion](xref:mvc/compatibility-version) en `Startup.ConfigureServices`:</span><span class="sxs-lookup"><span data-stu-id="1bb00-562">This behavior is enabled by the call to [SetCompatibilityVersion](xref:mvc/compatibility-version) in `Startup.ConfigureServices`:</span></span>
...
<span data-ttu-id="1bb00-563">Las plantillas predeterminadas generan la llamada `SetCompatibilityVersion` en ASP.NET Core 2.1 y 2.2.</span><span class="sxs-lookup"><span data-stu-id="1bb00-563">The default templates generate the `SetCompatibilityVersion` call in ASP.NET Core 2.1 and 2.2.</span></span> <span data-ttu-id="1bb00-564">`SetCompatibilityVersion` define con eficacia la opción de :::no-loc(Razor)::: Pages `true` como `AllowMappingHeadRequestsToGetHandler`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-564">`SetCompatibilityVersion` effectively sets the :::no-loc(Razor)::: Pages option `AllowMappingHeadRequestsToGetHandler` to `true`.</span></span>
...
## <a name="xsrfcsrf-and-no-locrazor-pages"></a><span data-ttu-id="1bb00-567">XSRF/CSRF y :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-567">XSRF/CSRF and :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-568">No tiene que escribir ningún código para la [validación antifalsificación](xref:security/anti-request-forgery).</span><span class="sxs-lookup"><span data-stu-id="1bb00-568">You don't have to write any code for [antiforgery validation](xref:security/anti-request-forgery).</span></span> <span data-ttu-id="1bb00-569">La validación y generación de tokens antifalsificación se incluyen automáticamente en :::no-loc(Razor)::: Pages.</span><span class="sxs-lookup"><span data-stu-id="1bb00-569">Antiforgery token generation and validation are automatically included in :::no-loc(Razor)::: Pages.</span></span>

<a name="layout"></a>

## <a name="using-layouts-partials-templates-and-tag-helpers-with-no-locrazor-pages"></a><span data-ttu-id="1bb00-570">Usar diseños, parciales, plantillas y asistentes de etiquetas con :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-570">Using Layouts, partials, templates, and Tag Helpers with :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="1bb00-571">Las páginas funcionan con todas las características del motor de vista de :::no-loc(Razor):::.</span><span class="sxs-lookup"><span data-stu-id="1bb00-571">Pages work with all the capabilities of the :::no-loc(Razor)::: view engine.</span></span> <span data-ttu-id="1bb00-572">Los diseños, parciales, plantillas, asistentes de etiquetas, *_ViewStart.cshtml* , *_ViewImports.cshtml* funcionan de la misma manera que lo hacen con las vistas de :::no-loc(Razor)::: convencionales.</span><span class="sxs-lookup"><span data-stu-id="1bb00-572">Layouts, partials, templates, Tag Helpers, *_ViewStart.cshtml* , *_ViewImports.cshtml* work in the same way they do for conventional :::no-loc(Razor)::: views.</span></span>
...
<span data-ttu-id="1bb00-580">El diseño está en la carpeta *Pages/Shared*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-580">The layout is in the *Pages/Shared* folder.</span></span> <span data-ttu-id="1bb00-581">Las páginas buscan otras vistas (diseños, plantillas, parciales) de forma jerárquica, a partir de la misma carpeta que la página actual.</span><span class="sxs-lookup"><span data-stu-id="1bb00-581">Pages look for other views (layouts, templates, partials) hierarchically, starting in the same folder as the current page.</span></span> <span data-ttu-id="1bb00-582">Un diseño en la carpeta *Pages/Shared* se puede usar desde cualquier página de :::no-loc(Razor)::: en la carpeta *Pages*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-582">A layout in the *Pages/Shared* folder can be used from any :::no-loc(Razor)::: page under the *Pages* folder.</span></span>
...
<span data-ttu-id="1bb00-584">Le recomendamos que **no** coloque el archivo de diseño en la carpeta *Views/Shared*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-584">We recommend you **not** put the layout file in the *Views/Shared* folder.</span></span> <span data-ttu-id="1bb00-585">*Views/Shared* es un patrón de vistas de MVC.</span><span class="sxs-lookup"><span data-stu-id="1bb00-585">*Views/Shared* is an MVC views pattern.</span></span> <span data-ttu-id="1bb00-586">:::no-loc(Razor)::: Pages está diseñado para basarse en la jerarquía de carpetas, no en las convenciones de ruta de acceso.</span><span class="sxs-lookup"><span data-stu-id="1bb00-586">:::no-loc(Razor)::: Pages are meant to rely on folder hierarchy, not path conventions.</span></span>

<span data-ttu-id="1bb00-587">La búsqueda de vistas de instancia de :::no-loc(Razor)::: Pages incluye la carpeta *Pages*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-587">View search from a :::no-loc(Razor)::: Page includes the *Pages* folder.</span></span> <span data-ttu-id="1bb00-588">Los diseños, plantillas y parciales que usa con los controladores de MVC y las vistas de :::no-loc(Razor)::: convencionales *simplemente funcionan*.</span><span class="sxs-lookup"><span data-stu-id="1bb00-588">The layouts, templates, and partials you're using with MVC controllers and conventional :::no-loc(Razor)::: views *just work*.</span></span>
...
<span data-ttu-id="1bb00-599">El espacio de nombres generado para la página de :::no-loc(Razor)::: *Pages/Customers/Edit.cshtml* es el mismo que la clase `PageModel`.</span><span class="sxs-lookup"><span data-stu-id="1bb00-599">The generated namespace for the *Pages/Customers/Edit.cshtml* :::no-loc(Razor)::: Page is the same as the `PageModel` class.</span></span>

<span data-ttu-id="1bb00-600">`@namespace` *también funciona con vistas de :::no-loc(Razor)::: convencionales.*</span><span class="sxs-lookup"><span data-stu-id="1bb00-600">`@namespace` *also works with conventional :::no-loc(Razor)::: views.*</span></span>
...
<span data-ttu-id="1bb00-603">El [proyecto de inicio de :::no-loc(Razor)::: Pages](#rpvs17) contiene *Pages/_ValidationScriptsPartial.cshtml* , que enlaza la validación del lado cliente.</span><span class="sxs-lookup"><span data-stu-id="1bb00-603">The [:::no-loc(Razor)::: Pages starter project](#rpvs17) contains the *Pages/_ValidationScriptsPartial.cshtml* , which hooks up client-side validation.</span></span>
...
<span data-ttu-id="1bb00-641">Se pueden pasar datos a una página con [ViewDataAttribute](/dotnet/api/microsoft.aspnetcore.mvc.viewdataattribute).</span><span class="sxs-lookup"><span data-stu-id="1bb00-641">Data can be passed to a page with [ViewDataAttribute](/dotnet/api/microsoft.aspnetcore.mvc.viewdataattribute).</span></span> <span data-ttu-id="1bb00-642">Los valores de las propiedades de los controladores o los modelos de :::no-loc(Razor)::: Pages con el atributo `[ViewData]` se almacenan y cargan desde [ViewDataDictionary](/dotnet/api/microsoft.aspnetcore.mvc.viewfeatures.viewdatadictionary).</span><span class="sxs-lookup"><span data-stu-id="1bb00-642">Properties on controllers or :::no-loc(Razor)::: Page models with the `[ViewData]` attribute have their values stored and loaded from the [ViewDataDictionary](/dotnet/api/microsoft.aspnetcore.mvc.viewfeatures.viewdatadictionary).</span></span>
...
<span data-ttu-id="1bb00-685">Para configurar opciones avanzadas, use el método de extensión `Add:::no-loc(Razor):::PagesOptions` en el generador de MVC:</span><span class="sxs-lookup"><span data-stu-id="1bb00-685">To configure advanced options, use the extension method `Add:::no-loc(Razor):::PagesOptions` on the MVC builder:</span></span>

[!code-csharp[](index/sample/:::no-loc(Razor):::PagesContacts/StartupAdvanced.cs?name=snippet_1)]

<span data-ttu-id="1bb00-686">Actualmente, puede usar `:::no-loc(Razor):::PagesOptions` para establecer el directorio raíz de páginas, o agregar convenciones de modelo de aplicación a las páginas.</span><span class="sxs-lookup"><span data-stu-id="1bb00-686">Currently you can use the `:::no-loc(Razor):::PagesOptions` to set the root directory for pages, or add application model conventions for pages.</span></span> <span data-ttu-id="1bb00-687">En el futuro habilitaremos más extensibilidad de este modo.</span><span class="sxs-lookup"><span data-stu-id="1bb00-687">We'll enable more extensibility this way in the future.</span></span>

<span data-ttu-id="1bb00-688">Para precompilar vistas, consulte la sección sobre la [compilación de vistas de :::no-loc(Razor):::](xref:mvc/views/view-compilation).</span><span class="sxs-lookup"><span data-stu-id="1bb00-688">To precompile views, see [:::no-loc(Razor)::: view compilation](xref:mvc/views/view-compilation) .</span></span>
...
### <a name="specify-that-no-locrazor-pages-are-at-a-custom-root-directory"></a><span data-ttu-id="1bb00-694">Especificación de :::no-loc(Razor)::: Pages en un directorio raíz personalizado</span><span class="sxs-lookup"><span data-stu-id="1bb00-694">Specify that :::no-loc(Razor)::: Pages are at a custom root directory</span></span>

<span data-ttu-id="1bb00-695">Agregue [With:::no-loc(Razor):::PagesRoot](/dotnet/api/microsoft.extensions.dependencyinjection.mvcrazorpagesmvccorebuilderextensions.withrazorpagesroot) a [AddMvc](/dotnet/api/microsoft.extensions.dependencyinjection.mvcservicecollectionextensions.addmvc#Microsoft_Extensions_DependencyInjection_MvcServiceCollectionExtensions_AddMvc_Microsoft_Extensions_DependencyInjection_IServiceCollection_) para especificar que :::no-loc(Razor)::: Pages se encuentra en un directorio raíz personalizado de la aplicación (proporcione la ruta de acceso relativa):</span><span class="sxs-lookup"><span data-stu-id="1bb00-695">Add [With:::no-loc(Razor):::PagesRoot](/dotnet/api/microsoft.extensions.dependencyinjection.mvcrazorpagesmvccorebuilderextensions.withrazorpagesroot) to [AddMvc](/dotnet/api/microsoft.extensions.dependencyinjection.mvcservicecollectionextensions.addmvc#Microsoft_Extensions_DependencyInjection_MvcServiceCollectionExtensions_AddMvc_Microsoft_Extensions_DependencyInjection_IServiceCollection_) to specify that your :::no-loc(Razor)::: Pages are at a custom root directory in the app (provide a relative path):</span></span>
...
* [<span data-ttu-id="1bb00-697">Autorización de atributos y :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="1bb00-697">Authorize attribute and :::no-loc(Razor)::: Pages</span></span>](xref:security/authorization/simple#aarp)
* <xref:index>
* <xref:mvc/views/razor>
* <xref:mvc/controllers/areas>
* <xref:tutorials/razor-pages/razor-pages-start>
