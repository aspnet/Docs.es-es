...
Identity 2,1 expone extremos con el `Identity` área. Por ejemplo, en la tabla siguiente se muestran ejemplos de Identity puntos de conexión que cambian de 2,0 a 2,1:
...
### <a name="update-no-locidentity-to-version-21"></a>Actualización Identity a la versión 2,1
...
### <a name="replace-no-locidentity-20-ui-with-the-no-locidentity-21-no-locrazor-class-library"></a>Reemplace Identity 2,0 UI por la Identity biblioteca de clases de 2,1 Razor

En esta sección se describen los pasos para reemplazar el código generado por la plantilla ASP.net Core 2,0 Identity por la [ASP.NET Core Identity](xref:security/authentication/identity) [ Razor biblioteca de clases](xref:razor-pages/ui-class). Los pasos siguientes son para un Razor proyecto de páginas, pero el enfoque para un proyecto de MVC es similar.
...
### <a name="update-after-scaffolding-no-locidentity"></a>Actualizar después del scaffolding Identity

* Elimine la Identity clase derivada generada por el scaffolding `IdentityDbContext` en la carpeta *areas/ Identity /Data/* .
* Eliminar *áreas/ Identity / Identity HostingStartup.CS*.
...
## <a name="changes-to-no-locrazor-pages-projects-no-locrazor-files"></a>Cambios en Razor los archivos de proyectos de páginas Razor
...
## <a name="changes-to-mvc-projects-no-locrazor-files"></a>Cambios en los archivos de proyectos de MVC Razor
...
* [Configuración de transporte de Libuv](xref:fundamentals/servers/kestrel#libuv-transport-configuration)
