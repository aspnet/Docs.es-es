...
<details>
    ...
    <ul>
        ...
        <li><span data-ttu-id="7720c-141">Microsoft. AspNetCore. Authentication. :::no-loc(Cookie)::: seg</span><span class="sxs-lookup"><span data-stu-id="7720c-141">Microsoft.AspNetCore.Authentication.:::no-loc(Cookie):::s</span></span></li>
        ...
        <li><span data-ttu-id="7720c-145">Microsoft. AspNetCore. :::no-loc(Cookie)::: Directivas</span><span class="sxs-lookup"><span data-stu-id="7720c-145">Microsoft.AspNetCore.:::no-loc(Cookie):::Policy</span></span></li>
        ...
        <li><span data-ttu-id="7720c-159">Microsoft. AspNetCore.:::no-loc(Identity):::</span><span class="sxs-lookup"><span data-stu-id="7720c-159">Microsoft.AspNetCore.:::no-loc(Identity):::</span></span></li>
        ...
        <li><span data-ttu-id="7720c-173">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="7720c-173">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::</span></span></li>
        <li><span data-ttu-id="7720c-174">Microsoft. AspNetCore. Mvc. :::no-loc(Razor)::: . ViewCompilation</span><span class="sxs-lookup"><span data-stu-id="7720c-174">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.ViewCompilation</span></span></li>
        <li><span data-ttu-id="7720c-175">Microsoft. AspNetCore. Mvc. :::no-loc(Razor)::: Páginas</span><span class="sxs-lookup"><span data-stu-id="7720c-175">Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages</span></span></li>
        ...
        <li><span data-ttu-id="7720c-178">Microsoft. AspNetCore.:::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="7720c-178">Microsoft.AspNetCore.:::no-loc(Razor):::</span></span></li>
        <li><span data-ttu-id="7720c-179">Microsoft. AspNetCore. :::no-loc(Razor)::: . Runtime</span><span class="sxs-lookup"><span data-stu-id="7720c-179">Microsoft.AspNetCore.:::no-loc(Razor):::.Runtime</span></span></li>
        <li><span data-ttu-id="7720c-180">Microsoft. AspNetCore. :::no-loc(Razor)::: . Concepción</span><span class="sxs-lookup"><span data-stu-id="7720c-180">Microsoft.AspNetCore.:::no-loc(Razor):::.Design</span></span></li>
        ...
        <li><span data-ttu-id="7720c-196">Microsoft. AspNetCore.:::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="7720c-196">Microsoft.AspNetCore.:::no-loc(SignalR):::</span></span></li>
        <li><span data-ttu-id="7720c-197">Microsoft. AspNetCore. :::no-loc(SignalR)::: . Core</span><span class="sxs-lookup"><span data-stu-id="7720c-197">Microsoft.AspNetCore.:::no-loc(SignalR):::.Core</span></span></li>
...
<span data-ttu-id="7720c-443">La asignación de :::no-loc(SignalR)::: hubs ahora tiene lugar dentro de `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="7720c-443">Mapping of :::no-loc(SignalR)::: hubs now takes place inside `UseEndpoints`.</span></span>
...
<span data-ttu-id="7720c-446">En el ejemplo siguiente, se agrega compatibilidad con el `ChatHub` :::no-loc(SignalR)::: concentrador:</span><span class="sxs-lookup"><span data-stu-id="7720c-446">In the following example, support for the `ChatHub` :::no-loc(SignalR)::: hub is added:</span></span>
...
### <a name="no-locrazor-pages"></a><span data-ttu-id="7720c-488">:::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="7720c-488">:::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="7720c-489">:::no-loc(Razor):::Ahora, las páginas de asignación tienen lugar dentro de `UseEndpoints` .</span><span class="sxs-lookup"><span data-stu-id="7720c-489">Mapping :::no-loc(Razor)::: Pages now takes place inside `UseEndpoints`.</span></span>

<span data-ttu-id="7720c-490">Agregue `Map:::no-loc(Razor):::Pages` si la aplicación usa :::no-loc(Razor)::: páginas.</span><span class="sxs-lookup"><span data-stu-id="7720c-490">Add `Map:::no-loc(Razor):::Pages` if the app uses :::no-loc(Razor)::: Pages.</span></span> <span data-ttu-id="7720c-491">Puesto que el enrutamiento del punto de conexión incluye compatibilidad con muchos marcos, agregar :::no-loc(Razor)::: páginas ahora es opcional.</span><span class="sxs-lookup"><span data-stu-id="7720c-491">Since Endpoint Routing includes support for many frameworks, adding :::no-loc(Razor)::: Pages is now opt-in.</span></span>

<span data-ttu-id="7720c-492">En el `Startup.Configure` método siguiente, `Map:::no-loc(Razor):::Pages` agrega compatibilidad con :::no-loc(Razor)::: las páginas:</span><span class="sxs-lookup"><span data-stu-id="7720c-492">In the following `Startup.Configure` method, `Map:::no-loc(Razor):::Pages` adds support for :::no-loc(Razor)::: Pages:</span></span>
...
## <a name="no-locidentity-ui"></a><span data-ttu-id="7720c-527">IU de :::no-loc(Identity):::</span><span class="sxs-lookup"><span data-stu-id="7720c-527">:::no-loc(Identity)::: UI</span></span>

<span data-ttu-id="7720c-528">:::no-loc(Identity)::: Actualizaciones de la interfaz de usuario para ASP.NET Core 3,0:</span><span class="sxs-lookup"><span data-stu-id="7720c-528">:::no-loc(Identity)::: UI updates for ASP.NET Core 3.0:</span></span>

* <span data-ttu-id="7720c-529">Agregue una referencia de paquete a [Microsoft. AspNetCore. :::no-loc(Identity)::: . Interfaz de usuario](https://nuget.org/packages/Microsoft.AspNetCore.:::no-loc(Identity):::.UI).</span><span class="sxs-lookup"><span data-stu-id="7720c-529">Add a package reference to [Microsoft.AspNetCore.:::no-loc(Identity):::.UI](https://nuget.org/packages/Microsoft.AspNetCore.:::no-loc(Identity):::.UI).</span></span>
* <span data-ttu-id="7720c-530">Las aplicaciones que no usan :::no-loc(Razor)::: páginas deben llamar a `Map:::no-loc(Razor):::Pages` .</span><span class="sxs-lookup"><span data-stu-id="7720c-530">Apps that don't use :::no-loc(Razor)::: Pages must call `Map:::no-loc(Razor):::Pages`.</span></span> <span data-ttu-id="7720c-531">Vea [ :::no-loc(Razor)::: las páginas](#razor-pages) de este documento.</span><span class="sxs-lookup"><span data-stu-id="7720c-531">See [:::no-loc(Razor)::: Pages](#razor-pages) in this document.</span></span>
* <span data-ttu-id="7720c-532">Bootstrap 4 es el marco de interfaz de usuario predeterminado.</span><span class="sxs-lookup"><span data-stu-id="7720c-532">Bootstrap 4 is the default UI framework.</span></span> <span data-ttu-id="7720c-533">Establezca una `:::no-loc(Identity):::UIFrameworkVersion` propiedad de proyecto para cambiar el valor predeterminado.</span><span class="sxs-lookup"><span data-stu-id="7720c-533">Set an `:::no-loc(Identity):::UIFrameworkVersion` project property to change the default.</span></span> <span data-ttu-id="7720c-534">Para obtener más información, consulte [este anuncio de github](https://github.com/aspnet/Announcements/issues/380).</span><span class="sxs-lookup"><span data-stu-id="7720c-534">For more information, see [this GitHub announcement](https://github.com/aspnet/Announcements/issues/380).</span></span>

## :::no-loc(SignalR):::

<span data-ttu-id="7720c-535">El :::no-loc(SignalR)::: cliente de JavaScript ha cambiado de `@aspnet/signalr` a `@microsoft/signalr` .</span><span class="sxs-lookup"><span data-stu-id="7720c-535">The :::no-loc(SignalR)::: JavaScript client has changed from `@aspnet/signalr` to `@microsoft/signalr`.</span></span> <span data-ttu-id="7720c-536">Para reaccionar a este cambio, cambie las referencias en *package.jsen* los archivos, las `require` instrucciones y las instrucciones de ECMAScript `import` .</span><span class="sxs-lookup"><span data-stu-id="7720c-536">To react to this change, change the references in *package.json* files, `require` statements, and ECMAScript `import` statements.</span></span>
...
1. <span data-ttu-id="7720c-559">Instale [Microsoft. AspNetCore. Mvc. :::no-loc(Razor)::: . ](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation) Paquete NuGet de RuntimeCompilation.</span><span class="sxs-lookup"><span data-stu-id="7720c-559">Install the [Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.RuntimeCompilation) NuGet package.</span></span>
1. <span data-ttu-id="7720c-560">Actualización `Startup.ConfigureServices` para llamar a `Add:::no-loc(Razor):::RuntimeCompilation` :</span><span class="sxs-lookup"><span data-stu-id="7720c-560">Update `Startup.ConfigureServices` to call `Add:::no-loc(Razor):::RuntimeCompilation`:</span></span>
    ...
    <span data-ttu-id="7720c-562">En el caso de :::no-loc(Razor)::: las páginas de ASP.net Core, utilice el siguiente código:</span><span class="sxs-lookup"><span data-stu-id="7720c-562">For ASP.NET Core :::no-loc(Razor)::: Pages, use the following code:</span></span>
...
<span data-ttu-id="7720c-564">Para obtener más información sobre la :::no-loc(Razor)::: compilación de archivos, vea <xref:mvc/views/view-compilation> .</span><span class="sxs-lookup"><span data-stu-id="7720c-564">For more information on :::no-loc(Razor)::: file compilation, see <xref:mvc/views/view-compilation>.</span></span>
