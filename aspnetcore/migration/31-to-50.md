...
Para más información, consulte <xref:blazor/security/webassembly/standalone-with-microsoft-accounts>.
...
Para más información, consulte <xref:blazor/security/webassembly/standalone-with-azure-active-directory>.
...
Para más información, consulte <xref:blazor/security/webassembly/standalone-with-azure-active-directory-b2c>.
