...
* La configuración de la plataforma se establece en **aplicación de una sola página (Spa)** en el Azure portal con el URI de redireccionamiento de la aplicación.
