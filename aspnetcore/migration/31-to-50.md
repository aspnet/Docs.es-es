...
>
> La capacidad de establecer la opción en `false` o dejarla desactivada, que establece de forma predeterminada la opción en `false` , *solo se proporciona por compatibilidad con versiones anteriores*.
>
