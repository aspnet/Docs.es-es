...
>
> La capacidad de establecer `PreferExactMatches` en `@false` o dejarlo desactivada, que establece la opción en `false` C# de forma predeterminada, *solo se proporciona por compatibilidad con versiones anteriores*.
>
