...
## <a name="changes-to-blazor-app-routing-logic-in-501-and-further-5x-releases-up-to-60"></a>Cambios en la Blazor lógica de enrutamiento de la aplicación en 5.0.1 y posteriores versiones 5. x hasta 6,0
...
## <a name="update-blazor-webassembly-and-blazor-server-projects"></a>Actualizar Blazor WebAssembly y Blazor Server proyectos
...
## <a name="update-blazor-webassembly-projects"></a>Actualizar Blazor WebAssembly proyectos
...
1. En `Program.Main` ( `Program.cs` ), cambie la referencia al `<app>` elemento a un selector de CSS agregando un hash `#` a él:
...
1. En `Program.Main` ( `Program.cs` ), cambie un registro transitorio predeterminado `HttpClient` a ámbito, si está presente:
...
1. En `Program.Main` ( `Program.cs` ) de la **`Client`** aplicación de soluciones hospedadas Blazor :
    
   * Opcionalmente, sustituya `builder.HostEnvironment.BaseAddress` por direcciones base de cliente de cadena.
   * Cambie los registros de generador de cliente transitorios con nombre a ámbito.
   ...
   En el código anterior, el `{APP NAMESPACE}` marcador de posición es el espacio de nombres de la aplicación.

### <a name="standalone-blazor-webassembly-app-with-microsoft-accounts"></a>Blazor WebAssemblyAplicación independiente con cuentas de Microsoft
...
### <a name="standalone-blazor-webassembly-app-with-azure-active-directory-aad"></a>Blazor WebAssemblyAplicación independiente con Azure Active Directory (AAD)
...
### <a name="standalone-blazor-webassembly-app-with-azure-active-directory-aad-b2c"></a>Blazor WebAssemblyAplicación independiente con Azure Active Directory (AAD) B2C
...
### <a name="hosted-blazor-webassembly-app-with-azure-active-directory-aad-or-aad-b2c"></a>Aplicación hospedada Blazor WebAssembly con Azure Active Directory (AAD) o AAD B2C
...
### <a name="update-the-server-project-of-a-hosted-blazor-solution"></a>Actualización del proyecto de servidor de una Blazor solución hospedada
...
## <a name="update-a-blazor-progressive-web-application-pwa"></a>Actualización de una Blazor aplicación web progresiva (PWA)
...
## <a name="update-razor-class-libraries-rcls"></a>Actualizar Razor bibliotecas de clases (RCLs)
...
## <a name="model-binding-changes-in-aspnet-core-mvc-and-razor-pages"></a>Cambios de enlace de modelos en ASP.NET Core MVC y Razor páginas
