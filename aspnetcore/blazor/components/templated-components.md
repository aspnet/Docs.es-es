...
---
# <a name="aspnet-core-no-locblazor-templated-components"></a><span data-ttu-id="200f0-103">Componentes con plantilla de :::no-loc(Blazor)::: en ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="200f0-103">ASP.NET Core :::no-loc(Blazor)::: templated components</span></span>
