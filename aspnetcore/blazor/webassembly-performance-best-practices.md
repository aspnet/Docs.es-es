...
<span data-ttu-id="2fcb4-141">[Blazor WebAssembly ofrece dos versiones más de <xref:Microsoft.JSInterop.IJSRuntime> con respecto a la única versión disponible en las aplicaciones [Blazor Server:</span><span class="sxs-lookup"><span data-stu-id="2fcb4-141">[Blazor WebAssembly offers two additional versions of <xref:Microsoft.JSInterop.IJSRuntime> over the single version available to [Blazor Server apps:</span></span>
