# <a name="blazor-server-sample-app"></a><span data-ttu-id="012d5-101">Aplicación de ejemplo de servidor Blazor</span><span class="sxs-lookup"><span data-stu-id="012d5-101">Blazor Server Sample App</span></span>
