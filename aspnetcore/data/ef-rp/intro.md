---
title: ':::no-loc(Razor)::: Pages con Entity Framework Core en ASP.NET Core: Tutorial 1 de 8'
author: rick-anderson
description: 'Se muestra cómo crear una aplicación de :::no-loc(Razor)::: Pages mediante Entity Framework Core'
ms.author: riande
...
---
# <a name="no-locrazor-pages-with-entity-framework-core-in-aspnet-core---tutorial-1-of-8"></a><span data-ttu-id="beb71-103">:::no-loc(Razor)::: Pages con Entity Framework Core en ASP.NET Core: Tutorial 1 de 8</span><span class="sxs-lookup"><span data-stu-id="beb71-103">:::no-loc(Razor)::: Pages with Entity Framework Core in ASP.NET Core - Tutorial 1 of 8</span></span>
...
<span data-ttu-id="beb71-105">Este es el primero de una serie de tutoriales en los que se muestra cómo usar Entity Framework (EF) Core en una [aplicación :::no-loc(Razor)::: Pages](xref:razor-pages/index) en ASP.NET Core.</span><span class="sxs-lookup"><span data-stu-id="beb71-105">This is the first in a series of tutorials that show how to use Entity Framework (EF) Core in an [ASP.NET Core :::no-loc(Razor)::: Pages](xref:razor-pages/index) app.</span></span> <span data-ttu-id="beb71-106">En el tutorial se crea un sitio web de una universidad ficticia, Contoso University.</span><span class="sxs-lookup"><span data-stu-id="beb71-106">The tutorials build a web site for a fictional Contoso University.</span></span> <span data-ttu-id="beb71-107">El sitio incluye funciones como la admisión de alumnos, la creación de cursos y las asignaciones de instructores.</span><span class="sxs-lookup"><span data-stu-id="beb71-107">The site includes functionality such as student admission, course creation, and instructor assignments.</span></span> <span data-ttu-id="beb71-108">En el tutorial se usa el enfoque de Code First.</span><span class="sxs-lookup"><span data-stu-id="beb71-108">The tutorial uses the code first approach.</span></span> <span data-ttu-id="beb71-109">Para obtener información sobre cómo seguir este tutorial mediante el enfoque de Database First, consulte [este problema de GitHub](https://github.com/dotnet/AspNetCore.Docs/issues/16897).</span><span class="sxs-lookup"><span data-stu-id="beb71-109">For information on following this tutorial using the database first approach, see [this Github issue](https://github.com/dotnet/AspNetCore.Docs/issues/16897).</span></span>
...
* <span data-ttu-id="beb71-113">Si no está familiarizado con :::no-loc(Razor)::: Pages, consulte la serie de tutoriales [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) antes de empezar este.</span><span class="sxs-lookup"><span data-stu-id="beb71-113">If you're new to :::no-loc(Razor)::: Pages, go through the [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) tutorial series before starting this one.</span></span>
...
* <span data-ttu-id="beb71-206">:::no-loc(Razor)::: Pages que controlan las operaciones de creación, lectura, actualización y eliminación (CRUD) de la entidad `Student`.</span><span class="sxs-lookup"><span data-stu-id="beb71-206">:::no-loc(Razor)::: pages that handle Create, Read, Update, and Delete (CRUD) operations for the `Student` entity.</span></span>
...
* <span data-ttu-id="beb71-210">En el cuadro de diálogo **Agregar nuevo elemento scaffold** :</span><span class="sxs-lookup"><span data-stu-id="beb71-210">In the **Add New Scaffold Item** dialog:</span></span>
  * <span data-ttu-id="beb71-211">En la pestaña de la izquierda, seleccione **Instalado > Común > Páginas :::no-loc(Razor):::** .</span><span class="sxs-lookup"><span data-stu-id="beb71-211">In the left tab, select **Installed > Common > :::no-loc(Razor)::: Pages**</span></span>
  * <span data-ttu-id="beb71-212">Seleccione **Páginas de :::no-loc(Razor)::: que usan Entity Framework (CRUD)** > **Agregar**.</span><span class="sxs-lookup"><span data-stu-id="beb71-212">Select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **ADD**.</span></span>
* <span data-ttu-id="beb71-213">En el cuadro de diálogo para **agregar instancias de :::no-loc(Razor)::: Pages que usan Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="beb71-213">In the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
...
* <span data-ttu-id="beb71-231">Crea :::no-loc(Razor)::: Pages en la carpeta *Pages/Students* :</span><span class="sxs-lookup"><span data-stu-id="beb71-231">Creates :::no-loc(Razor)::: pages in the *Pages/Students* folder:</span></span>
...
* <span data-ttu-id="beb71-239">Agrega una cadena de conexión de la base de datos a *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="beb71-239">Adds a database connection string to *:::no-loc(appsettings.json):::*.</span></span>
...
<span data-ttu-id="beb71-241">La herramienta de scaffolding genera una cadena de conexión en el archivo *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="beb71-241">The scaffolding tool generates a connection string in the *:::no-loc(appsettings.json):::* file.</span></span>
...
<span data-ttu-id="beb71-254">El código anterior cambia del elemento `DbSet<Student> Student` singular al `DbSet<Student> Students` plural.</span><span class="sxs-lookup"><span data-stu-id="beb71-254">The preceding code changes from the singular `DbSet<Student> Student` to the  plural `DbSet<Student> Students`.</span></span> <span data-ttu-id="beb71-255">Para que el código de las páginas :::no-loc(Razor)::: coincida con el nombre nuevo de `DBSet`, realice un cambio global de: `_context.Student.`</span><span class="sxs-lookup"><span data-stu-id="beb71-255">To make the :::no-loc(Razor)::: Pages code match the new `DBSet` name, make a global change from: `_context.Student.`</span></span>
...
<span data-ttu-id="beb71-372">Este es el primero de una serie de tutoriales en los que se muestra cómo usar Entity Framework (EF) Core en una [aplicación :::no-loc(Razor)::: Pages](xref:razor-pages/index) en ASP.NET Core.</span><span class="sxs-lookup"><span data-stu-id="beb71-372">This is the first in a series of tutorials that show how to use Entity Framework (EF) Core in an [ASP.NET Core :::no-loc(Razor)::: Pages](xref:razor-pages/index) app.</span></span> <span data-ttu-id="beb71-373">En el tutorial se crea un sitio web de una universidad ficticia, Contoso University.</span><span class="sxs-lookup"><span data-stu-id="beb71-373">The tutorials build a web site for a fictional Contoso University.</span></span> <span data-ttu-id="beb71-374">El sitio incluye funciones como la admisión de alumnos, la creación de cursos y las asignaciones de instructores.</span><span class="sxs-lookup"><span data-stu-id="beb71-374">The site includes functionality such as student admission, course creation, and instructor assignments.</span></span> <span data-ttu-id="beb71-375">En el tutorial se usa el enfoque de Code First.</span><span class="sxs-lookup"><span data-stu-id="beb71-375">The tutorial uses the code first approach.</span></span> <span data-ttu-id="beb71-376">Para obtener información sobre cómo seguir este tutorial mediante el enfoque de Database First, consulte [este problema de GitHub](https://github.com/dotnet/AspNetCore.Docs/issues/16897).</span><span class="sxs-lookup"><span data-stu-id="beb71-376">For information on following this tutorial using the database first approach, see [this Github issue](https://github.com/dotnet/AspNetCore.Docs/issues/16897).</span></span>
...
* <span data-ttu-id="beb71-380">Si no está familiarizado con :::no-loc(Razor)::: Pages, consulte la serie de tutoriales [Introducción a :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) antes de empezar este.</span><span class="sxs-lookup"><span data-stu-id="beb71-380">If you're new to :::no-loc(Razor)::: Pages, go through the [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) tutorial series before starting this one.</span></span>
...
* <span data-ttu-id="beb71-426">Ejecute los comandos siguientes para crear un proyecto de :::no-loc(Razor)::: Pages y `cd` para acceder a la nueva carpeta del proyecto:</span><span class="sxs-lookup"><span data-stu-id="beb71-426">Run the following commands to create a :::no-loc(Razor)::: Pages project and `cd` into the new project folder:</span></span>
...
* <span data-ttu-id="beb71-488">:::no-loc(Razor)::: Pages que controlan las operaciones de creación, lectura, actualización y eliminación (CRUD) de la entidad `Student`.</span><span class="sxs-lookup"><span data-stu-id="beb71-488">:::no-loc(Razor)::: pages that handle Create, Read, Update, and Delete (CRUD) operations for the `Student` entity.</span></span>
...
* <span data-ttu-id="beb71-492">En el cuadro de diálogo **Agregar scaffold** , seleccione **Páginas de :::no-loc(Razor)::: que usan Entity Framework (CRUD)** > **AGREGAR**.</span><span class="sxs-lookup"><span data-stu-id="beb71-492">In the **Add Scaffold** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **ADD**.</span></span>
* <span data-ttu-id="beb71-493">En el cuadro de diálogo para **agregar instancias de :::no-loc(Razor)::: Pages que usan Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="beb71-493">In the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
...
* <span data-ttu-id="beb71-510">Crea :::no-loc(Razor)::: Pages en la carpeta *Pages/Students* :</span><span class="sxs-lookup"><span data-stu-id="beb71-510">Creates :::no-loc(Razor)::: pages in the *Pages/Students* folder:</span></span>
...
* <span data-ttu-id="beb71-518">Agrega una cadena de conexión de la base de datos a *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="beb71-518">Adds a database connection string to *:::no-loc(appsettings.json):::*.</span></span>
...
<span data-ttu-id="beb71-521">El archivo *:::no-loc(appsettings.json):::* especifica la cadena de conexión [SQL Server LocalDB](/sql/database-engine/configure-windows/sql-server-2016-express-localdb).</span><span class="sxs-lookup"><span data-stu-id="beb71-521">The *:::no-loc(appsettings.json):::* file specifies the connection string [SQL Server LocalDB](/sql/database-engine/configure-windows/sql-server-2016-express-localdb).</span></span>
...
<span data-ttu-id="beb71-538">Para que el código de :::no-loc(Razor)::: Pages coincida con el nuevo nombre de DBSet, realice un cambio global de `_context.Student` a `_context.Students` en todo el proyecto.</span><span class="sxs-lookup"><span data-stu-id="beb71-538">To make the :::no-loc(Razor)::: Pages code match the new DBSet name, make a global change across the whole project of `_context.Student` to `_context.Students`.</span></span>  <span data-ttu-id="beb71-539">Hay ocho repeticiones.</span><span class="sxs-lookup"><span data-stu-id="beb71-539">There are 8 occurrences.</span></span>
...
<span data-ttu-id="beb71-625">En la aplicación web de ejemplo Contoso University se muestra cómo crear una aplicación web de :::no-loc(Razor)::: Pages de ASP.NET Core con Entity Framework (EF) Core.</span><span class="sxs-lookup"><span data-stu-id="beb71-625">The Contoso University sample web app demonstrates how to create an ASP.NET Core :::no-loc(Razor)::: Pages app using Entity Framework (EF) Core.</span></span>
...
<span data-ttu-id="beb71-634">Familiaridad con [:::no-loc(Razor)::: Pages](xref:razor-pages/index).</span><span class="sxs-lookup"><span data-stu-id="beb71-634">Familiarity with [:::no-loc(Razor)::: Pages](xref:razor-pages/index).</span></span> <span data-ttu-id="beb71-635">Los programadores nuevos deben completar [Introducción a :::no-loc(Razor)::: Pages en ASP.NET Core](xref:tutorials/razor-pages/razor-pages-start) antes de empezar esta serie.</span><span class="sxs-lookup"><span data-stu-id="beb71-635">New programmers should complete [Get started with :::no-loc(Razor)::: Pages](xref:tutorials/razor-pages/razor-pages-start) before starting this series.</span></span>
...
<span data-ttu-id="beb71-645">El estilo de la interfaz de usuario de este sitio se mantiene fiel a lo que generan las plantillas integradas.</span><span class="sxs-lookup"><span data-stu-id="beb71-645">The UI style of this site is close to what's generated by the built-in templates.</span></span> <span data-ttu-id="beb71-646">El tutorial se centra en EF Core con :::no-loc(Razor)::: Pages, no en la interfaz de usuario.</span><span class="sxs-lookup"><span data-stu-id="beb71-646">The tutorial focus is on EF Core with :::no-loc(Razor)::: Pages, not the UI.</span></span>

## <a name="create-the-contosouniversity-no-locrazor-pages-web-app"></a><span data-ttu-id="beb71-647">Creación de la aplicación web de :::no-loc(Razor)::: Pages ContosoUniversity</span><span class="sxs-lookup"><span data-stu-id="beb71-647">Create the ContosoUniversity :::no-loc(Razor)::: Pages web app</span></span>
...
<span data-ttu-id="beb71-654">Para ver las imágenes de los pasos anteriores, consulte [Creación de una aplicación web de :::no-loc(Razor):::](xref:tutorials/razor-pages/razor-pages-start#create-a-razor-pages-web-app).</span><span class="sxs-lookup"><span data-stu-id="beb71-654">For images of the preceding steps, see [Create a :::no-loc(Razor)::: web app](xref:tutorials/razor-pages/razor-pages-start#create-a-razor-pages-web-app).</span></span>
...
* <span data-ttu-id="beb71-727">En el cuadro de diálogo **Agregar scaffold** , seleccione **Páginas de :::no-loc(Razor)::: que usan Entity Framework (CRUD)** > **AGREGAR**.</span><span class="sxs-lookup"><span data-stu-id="beb71-727">In the **Add Scaffold** dialog, select **:::no-loc(Razor)::: Pages using Entity Framework (CRUD)** > **ADD**.</span></span>

<span data-ttu-id="beb71-728">Complete el cuadro de diálogo para **agregar instancias de :::no-loc(Razor)::: Pages que usan Entity Framework (CRUD)** :</span><span class="sxs-lookup"><span data-stu-id="beb71-728">Complete the **Add :::no-loc(Razor)::: Pages using Entity Framework (CRUD)** dialog:</span></span>
...
* <span data-ttu-id="beb71-743">*:::no-loc(appsettings.json):::* : se agrega la cadena de conexión que se usa para conectarse a una base de datos local.</span><span class="sxs-lookup"><span data-stu-id="beb71-743">*:::no-loc(appsettings.json):::* : The connection string used to connect to a local database is added.</span></span>
...
<span data-ttu-id="beb71-773">Ejecute la aplicación y acepte la directiva de :::no-loc(cookie):::s.</span><span class="sxs-lookup"><span data-stu-id="beb71-773">Run the app and accept the :::no-loc(cookie)::: policy.</span></span> <span data-ttu-id="beb71-774">Esta aplicación no conserva información de carácter personal.</span><span class="sxs-lookup"><span data-stu-id="beb71-774">This app doesn't keep personal information.</span></span> <span data-ttu-id="beb71-775">Puede obtener más información sobre la directiva de :::no-loc(cookie):::s en [Compatibilidad con el Reglamento general de protección de datos (RGPD) de la UE](xref:security/gdpr).</span><span class="sxs-lookup"><span data-stu-id="beb71-775">You can read about the :::no-loc(cookie)::: policy at [EU General Data Protection Regulation (GDPR) support](xref:security/gdpr).</span></span>
