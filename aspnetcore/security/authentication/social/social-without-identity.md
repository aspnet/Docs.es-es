...
---
# <a name="use-social-sign-in-provider-authentication-without-aspnet-core-no-locidentity"></a>Usar la autenticación de proveedor de inicio de sesión social sin ASP.NET CoreIdentity
