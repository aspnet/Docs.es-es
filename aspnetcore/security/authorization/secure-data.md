...
<span data-ttu-id="f17e0-124">Los botones **aprobar** y **rechazar** solo se muestran para administradores y administradores.</span><span class="sxs-lookup"><span data-stu-id="f17e0-124">The **Approve** and **Reject** buttons are only displayed for managers and administrators.</span></span>
...
## <a name="the-starter-and-completed-app"></a><span data-ttu-id="f17e0-142">La aplicación de inicio y completada</span><span class="sxs-lookup"><span data-stu-id="f17e0-142">The starter and completed app</span></span>
...
<span data-ttu-id="f17e0-164">La Directiva de autenticación de reserva:</span><span class="sxs-lookup"><span data-stu-id="f17e0-164">The fallback authentication policy:</span></span>
...
<span data-ttu-id="f17e0-202">Cree una `ContactManagerAuthorizationHandler` clase en la carpeta de *autorización* .</span><span class="sxs-lookup"><span data-stu-id="f17e0-202">Create a `ContactManagerAuthorizationHandler` class in the *Authorization* folder.</span></span> <span data-ttu-id="f17e0-203">`ContactManagerAuthorizationHandler`Comprueba que el usuario que actúa en el recurso es un administrador.</span><span class="sxs-lookup"><span data-stu-id="f17e0-203">The `ContactManagerAuthorizationHandler` verifies the user acting on the resource is a manager.</span></span> <span data-ttu-id="f17e0-204">Solo los administradores pueden aprobar o rechazar cambios de contenido (nuevos o modificados).</span><span class="sxs-lookup"><span data-stu-id="f17e0-204">Only managers can approve or reject content changes (new or changed).</span></span>
...
### <a name="update-the-createmodel"></a><span data-ttu-id="f17e0-228">Actualización de CreateModel</span><span class="sxs-lookup"><span data-stu-id="f17e0-228">Update the CreateModel</span></span>
...
### <a name="update-details"></a><span data-ttu-id="f17e0-253">Detalles de la actualización</span><span class="sxs-lookup"><span data-stu-id="f17e0-253">Update Details</span></span>
...
* <span data-ttu-id="f17e0-282">Los usuarios registrados pueden ver todos los datos de contacto aprobados.</span><span class="sxs-lookup"><span data-stu-id="f17e0-282">Registered users can view all of the approved contact data.</span></span>
...
* <span data-ttu-id="f17e0-304">Agregue *Models/contact. CS*:</span><span class="sxs-lookup"><span data-stu-id="f17e0-304">Add *Models/Contact.cs*:</span></span>
...
## <a name="the-starter-and-completed-app"></a><span data-ttu-id="f17e0-349">La aplicación de inicio y completada</span><span class="sxs-lookup"><span data-stu-id="f17e0-349">The starter and completed app</span></span>
...
### <a name="create-a-manager-authorization-handler"></a><span data-ttu-id="f17e0-395">Crear un controlador de autorización de administrador</span><span class="sxs-lookup"><span data-stu-id="f17e0-395">Create a manager authorization handler</span></span>
...
### <a name="update-the-createmodel"></a><span data-ttu-id="f17e0-422">Actualización de CreateModel</span><span class="sxs-lookup"><span data-stu-id="f17e0-422">Update the CreateModel</span></span>
...
> [!WARNING]
> <span data-ttu-id="f17e0-443">Ocultar los vínculos de los usuarios que no tienen permiso para cambiar datos no protege la aplicación.</span><span class="sxs-lookup"><span data-stu-id="f17e0-443">Hiding links from users that don't have permission to change data doesn't secure the app.</span></span> <span data-ttu-id="f17e0-444">La ocultación de los vínculos hace que la aplicación sea más fácil de ver mostrando solo vínculos válidos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-444">Hiding links makes the app more user-friendly by displaying only valid links.</span></span> <span data-ttu-id="f17e0-445">Los usuarios pueden atacar las direcciones URL generadas para invocar operaciones de edición y eliminación en los datos que no son de su propiedad.</span><span class="sxs-lookup"><span data-stu-id="f17e0-445">Users can hack the generated URLs to invoke edit and delete operations on data they don't own.</span></span> <span data-ttu-id="f17e0-446">La Razor página o el controlador debe aplicar comprobaciones de acceso para proteger los datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-446">The Razor Page or controller must enforce access checks to secure the data.</span></span>

### <a name="update-details"></a><span data-ttu-id="f17e0-447">Detalles de la actualización</span><span class="sxs-lookup"><span data-stu-id="f17e0-447">Update Details</span></span>

<span data-ttu-id="f17e0-448">Actualice la vista de detalles para que los administradores puedan aprobar o rechazar contactos:</span><span class="sxs-lookup"><span data-stu-id="f17e0-448">Update the details view so managers can approve or reject contacts:</span></span>

[!code-cshtml[](secure-data/samples/final2.1/Pages/Contacts/Details.cshtml?name=snippet)]

<span data-ttu-id="f17e0-449">Actualice el modelo de página de detalles:</span><span class="sxs-lookup"><span data-stu-id="f17e0-449">Update the details page model:</span></span>

[!code-csharp[](secure-data/samples/final2.1/Pages/Contacts/Details.cshtml.cs?name=snippet)]

## <a name="add-or-remove-a-user-to-a-role"></a><span data-ttu-id="f17e0-450">Agregar o quitar un usuario de un rol</span><span class="sxs-lookup"><span data-stu-id="f17e0-450">Add or remove a user to a role</span></span>

<span data-ttu-id="f17e0-451">Consulte [este problema](https://github.com/dotnet/AspNetCore.Docs/issues/8502) para obtener información sobre:</span><span class="sxs-lookup"><span data-stu-id="f17e0-451">See [this issue](https://github.com/dotnet/AspNetCore.Docs/issues/8502) for information on:</span></span>

* <span data-ttu-id="f17e0-452">Quitar privilegios de un usuario.</span><span class="sxs-lookup"><span data-stu-id="f17e0-452">Removing privileges from a user.</span></span> <span data-ttu-id="f17e0-453">Por ejemplo, silenciar a un usuario en una aplicación de chat.</span><span class="sxs-lookup"><span data-stu-id="f17e0-453">For example, muting a user in a chat app.</span></span>
* <span data-ttu-id="f17e0-454">Agregar privilegios a un usuario.</span><span class="sxs-lookup"><span data-stu-id="f17e0-454">Adding privileges to a user.</span></span>

## <a name="test-the-completed-app"></a><span data-ttu-id="f17e0-455">Prueba de la aplicación completada</span><span class="sxs-lookup"><span data-stu-id="f17e0-455">Test the completed app</span></span>

<span data-ttu-id="f17e0-456">Si aún no ha establecido una contraseña para las cuentas de usuario inicializadas, use la [herramienta Administrador de secretos](xref:security/app-secrets#secret-manager) para establecer una contraseña:</span><span class="sxs-lookup"><span data-stu-id="f17e0-456">If you haven't already set a password for seeded user accounts, use the [Secret Manager tool](xref:security/app-secrets#secret-manager) to set a password:</span></span>

* <span data-ttu-id="f17e0-457">Elija una contraseña segura: Use ocho o más caracteres y, al menos, un carácter en mayúscula, un número y un símbolo.</span><span class="sxs-lookup"><span data-stu-id="f17e0-457">Choose a strong password: Use eight or more characters and at least one upper-case character, number, and symbol.</span></span> <span data-ttu-id="f17e0-458">Por ejemplo, `Passw0rd!` cumple los requisitos de contraseñas seguras.</span><span class="sxs-lookup"><span data-stu-id="f17e0-458">For example, `Passw0rd!` meets the strong password requirements.</span></span>
* <span data-ttu-id="f17e0-459">Ejecute el siguiente comando desde la carpeta del proyecto, donde `<PW>` es la contraseña:</span><span class="sxs-lookup"><span data-stu-id="f17e0-459">Execute the following command from the project's folder, where `<PW>` is the password:</span></span>

  ```dotnetcli
  dotnet user-secrets set SeedUserPW <PW>
  ```

* <span data-ttu-id="f17e0-460">Quitar y actualizar la base de datos</span><span class="sxs-lookup"><span data-stu-id="f17e0-460">Drop and update the Database</span></span>
...
* <span data-ttu-id="f17e0-461">Reinicie la aplicación para inicializar la base de datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-461">Restart the app to seed the database.</span></span>

<span data-ttu-id="f17e0-462">Una manera fácil de probar la aplicación completada es iniciar tres exploradores diferentes (o sesiones de incógnito/InPrivate).</span><span class="sxs-lookup"><span data-stu-id="f17e0-462">An easy way to test the completed app is to launch three different browsers (or incognito/InPrivate sessions).</span></span> <span data-ttu-id="f17e0-463">En un explorador, registre un nuevo usuario (por ejemplo, `test@example.com` ).</span><span class="sxs-lookup"><span data-stu-id="f17e0-463">In one browser, register a new user (for example, `test@example.com`).</span></span> <span data-ttu-id="f17e0-464">Inicie sesión en cada explorador con un usuario diferente.</span><span class="sxs-lookup"><span data-stu-id="f17e0-464">Sign in to each browser with a different user.</span></span> <span data-ttu-id="f17e0-465">Compruebe las siguientes operaciones:</span><span class="sxs-lookup"><span data-stu-id="f17e0-465">Verify the following operations:</span></span>

* <span data-ttu-id="f17e0-466">Los usuarios registrados pueden ver todos los datos de contacto aprobados.</span><span class="sxs-lookup"><span data-stu-id="f17e0-466">Registered users can view all of the approved contact data.</span></span>
* <span data-ttu-id="f17e0-467">Los usuarios registrados pueden editar o eliminar sus propios datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-467">Registered users can edit/delete their own data.</span></span>
* <span data-ttu-id="f17e0-468">Los administradores pueden aprobar o rechazar datos de contacto.</span><span class="sxs-lookup"><span data-stu-id="f17e0-468">Managers can approve/reject contact data.</span></span> <span data-ttu-id="f17e0-469">La `Details` vista muestra los botones **aprobar** y **rechazar** .</span><span class="sxs-lookup"><span data-stu-id="f17e0-469">The `Details` view shows **Approve** and **Reject** buttons.</span></span>
* <span data-ttu-id="f17e0-470">Los administradores pueden aprobar o rechazar y editar o eliminar todos los datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-470">Administrators can approve/reject and edit/delete all data.</span></span>

| <span data-ttu-id="f17e0-471">Usuario</span><span class="sxs-lookup"><span data-stu-id="f17e0-471">User</span></span>                | <span data-ttu-id="f17e0-472">Inicializado por la aplicación</span><span class="sxs-lookup"><span data-stu-id="f17e0-472">Seeded by the app</span></span> | <span data-ttu-id="f17e0-473">Opciones</span><span class="sxs-lookup"><span data-stu-id="f17e0-473">Options</span></span>                                  |
| ------------------- | :---------------: | ---------------------------------------- |
| test@example.com    | <span data-ttu-id="f17e0-474">No</span><span class="sxs-lookup"><span data-stu-id="f17e0-474">No</span></span>                | <span data-ttu-id="f17e0-475">Edite o elimine los datos propios.</span><span class="sxs-lookup"><span data-stu-id="f17e0-475">Edit/delete the own data.</span></span>                |
| manager@contoso.com | <span data-ttu-id="f17e0-476">Sí</span><span class="sxs-lookup"><span data-stu-id="f17e0-476">Yes</span></span>               | <span data-ttu-id="f17e0-477">Aprobar/rechazar y editar o eliminar los datos propios.</span><span class="sxs-lookup"><span data-stu-id="f17e0-477">Approve/reject and edit/delete own data.</span></span> |
| admin@contoso.com   | <span data-ttu-id="f17e0-478">Sí</span><span class="sxs-lookup"><span data-stu-id="f17e0-478">Yes</span></span>               | <span data-ttu-id="f17e0-479">Aprobar/rechazar y editar o eliminar todos los datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-479">Approve/reject and edit/delete all data.</span></span> |

<span data-ttu-id="f17e0-480">Cree un contacto en el explorador del administrador.</span><span class="sxs-lookup"><span data-stu-id="f17e0-480">Create a contact in the administrator's browser.</span></span> <span data-ttu-id="f17e0-481">Copie la dirección URL para eliminar y editar del contacto del administrador.</span><span class="sxs-lookup"><span data-stu-id="f17e0-481">Copy the URL for delete and edit from the administrator contact.</span></span> <span data-ttu-id="f17e0-482">Pegue estos vínculos en el explorador del usuario de prueba para comprobar que el usuario de prueba no puede realizar estas operaciones.</span><span class="sxs-lookup"><span data-stu-id="f17e0-482">Paste these links into the test user's browser to verify the test user can't perform these operations.</span></span>

## <a name="create-the-starter-app"></a><span data-ttu-id="f17e0-483">Creación de la aplicación de inicio</span><span class="sxs-lookup"><span data-stu-id="f17e0-483">Create the starter app</span></span>

* <span data-ttu-id="f17e0-484">Crear una Razor aplicación de páginas denominada "ContactManager"</span><span class="sxs-lookup"><span data-stu-id="f17e0-484">Create a Razor Pages app named "ContactManager"</span></span>
  * <span data-ttu-id="f17e0-485">Cree la aplicación con **cuentas de usuario individuales**.</span><span class="sxs-lookup"><span data-stu-id="f17e0-485">Create the app with **Individual User Accounts**.</span></span>
  * <span data-ttu-id="f17e0-486">Asígnele el nombre "ContactManager" para que el espacio de nombres coincida con el espacio de nombres usado en el ejemplo.</span><span class="sxs-lookup"><span data-stu-id="f17e0-486">Name it "ContactManager" so the namespace matches the namespace used in the sample.</span></span>
  * <span data-ttu-id="f17e0-487">`-uld` especifica LocalDB en lugar de SQLite.</span><span class="sxs-lookup"><span data-stu-id="f17e0-487">`-uld` specifies LocalDB instead of SQLite</span></span>

  ```dotnetcli
  dotnet new webapp -o ContactManager -au Individual -uld
  ```

* <span data-ttu-id="f17e0-488">Agregue *Models/contact. CS*:</span><span class="sxs-lookup"><span data-stu-id="f17e0-488">Add *Models/Contact.cs*:</span></span>

  [!code-csharp[](secure-data/samples/starter2.1/Models/Contact.cs?name=snippet1)]

* <span data-ttu-id="f17e0-489">Aplicar scaffolding al `Contact` modelo.</span><span class="sxs-lookup"><span data-stu-id="f17e0-489">Scaffold the `Contact` model.</span></span>
* <span data-ttu-id="f17e0-490">Cree la migración inicial y actualice la base de datos:</span><span class="sxs-lookup"><span data-stu-id="f17e0-490">Create initial migration and update the database:</span></span>
...
* <span data-ttu-id="f17e0-491">Actualice el delimitador **ContactManager** en el archivo *pages/_Layout. cshtml* :</span><span class="sxs-lookup"><span data-stu-id="f17e0-491">Update the **ContactManager** anchor in the *Pages/_Layout.cshtml* file:</span></span>

  ```cshtml
  <a asp-page="/Contacts/Index" class="navbar-brand">ContactManager</a>
  ```

* <span data-ttu-id="f17e0-492">Prueba de la aplicación mediante la creación, edición y eliminación de un contacto</span><span class="sxs-lookup"><span data-stu-id="f17e0-492">Test the app by creating, editing, and deleting a contact</span></span>

### <a name="seed-the-database"></a><span data-ttu-id="f17e0-493">Inicializar la base de datos</span><span class="sxs-lookup"><span data-stu-id="f17e0-493">Seed the database</span></span>

<span data-ttu-id="f17e0-494">Agregue la clase [SeedData](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/security/authorization/secure-data/samples/starter2.1/Data/SeedData.cs) a la carpeta de *datos* .</span><span class="sxs-lookup"><span data-stu-id="f17e0-494">Add the [SeedData](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/security/authorization/secure-data/samples/starter2.1/Data/SeedData.cs) class to the *Data* folder.</span></span>

<span data-ttu-id="f17e0-495">Llamada `SeedData.Initialize` desde `Main` :</span><span class="sxs-lookup"><span data-stu-id="f17e0-495">Call `SeedData.Initialize` from `Main`:</span></span>

[!code-csharp[](secure-data/samples/starter2.1/Program.cs?name=snippet)]

<span data-ttu-id="f17e0-496">Compruebe que la aplicación ha inicializado la base de datos.</span><span class="sxs-lookup"><span data-stu-id="f17e0-496">Test that the app seeded the database.</span></span> <span data-ttu-id="f17e0-497">Si hay alguna fila en la base de de contactos, el método de inicialización no se ejecuta.</span><span class="sxs-lookup"><span data-stu-id="f17e0-497">If there are any rows in the contact DB, the seed method doesn't run.</span></span>

::: moniker-end

<a name="secure-data-add-resources-label"></a>

### <a name="additional-resources"></a><span data-ttu-id="f17e0-498">Recursos adicionales</span><span class="sxs-lookup"><span data-stu-id="f17e0-498">Additional resources</span></span>

* [<span data-ttu-id="f17e0-499">Creación de una aplicación .NET Core y SQL Database en Azure App Service</span><span class="sxs-lookup"><span data-stu-id="f17e0-499">Build a .NET Core and SQL Database web app in Azure App Service</span></span>](/azure/app-service/app-service-web-tutorial-dotnetcore-sqldb)
* <span data-ttu-id="f17e0-500">[ASP.net Core laboratorio de autorización](https://github.com/blowdart/AspNetAuthorizationWorkshop).</span><span class="sxs-lookup"><span data-stu-id="f17e0-500">[ASP.NET Core Authorization Lab](https://github.com/blowdart/AspNetAuthorizationWorkshop).</span></span> <span data-ttu-id="f17e0-501">En este laboratorio se incluyen más detalles sobre las características de seguridad que se presentan en este tutorial.</span><span class="sxs-lookup"><span data-stu-id="f17e0-501">This lab goes into more detail on the security features introduced in this tutorial.</span></span>
* <xref:security/authorization/introduction>
* [<span data-ttu-id="f17e0-502">Autorización personalizada basada en directivas</span><span class="sxs-lookup"><span data-stu-id="f17e0-502">Custom policy-based authorization</span></span>](xref:security/authorization/policies)
