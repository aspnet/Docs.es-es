...
<span data-ttu-id="e900c-187">Almacenar las contraseñas en texto sin formato no es seguro.</span><span class="sxs-lookup"><span data-stu-id="e900c-187">Storing passwords in plain text is insecure.</span></span> <span data-ttu-id="e900c-188">Por ejemplo, una cadena de conexión de base de datos almacenada en *:::no-loc(appsettings.json):::* puede incluir una contraseña para el usuario especificado:</span><span class="sxs-lookup"><span data-stu-id="e900c-188">For example, a database connection string stored in *:::no-loc(appsettings.json):::* may include a password for the specified user:</span></span>
...
<span data-ttu-id="e900c-191">Quite el `Password` par clave-valor de la cadena de conexión de *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="e900c-191">Remove the `Password` key-value pair from the connection string in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="e900c-192">Por ejemplo:</span><span class="sxs-lookup"><span data-stu-id="e900c-192">For example:</span></span>
...
<span data-ttu-id="e900c-290">Almacenar las contraseñas en texto sin formato no es seguro.</span><span class="sxs-lookup"><span data-stu-id="e900c-290">Storing passwords in plain text is insecure.</span></span> <span data-ttu-id="e900c-291">Por ejemplo, una cadena de conexión de base de datos almacenada en *:::no-loc(appsettings.json):::* puede incluir una contraseña para el usuario especificado:</span><span class="sxs-lookup"><span data-stu-id="e900c-291">For example, a database connection string stored in *:::no-loc(appsettings.json):::* may include a password for the specified user:</span></span>
...
<span data-ttu-id="e900c-294">Quite el `Password` par clave-valor de la cadena de conexión de *:::no-loc(appsettings.json):::* .</span><span class="sxs-lookup"><span data-stu-id="e900c-294">Remove the `Password` key-value pair from the connection string in *:::no-loc(appsettings.json):::* .</span></span> <span data-ttu-id="e900c-295">Por ejemplo:</span><span class="sxs-lookup"><span data-stu-id="e900c-295">For example:</span></span>
