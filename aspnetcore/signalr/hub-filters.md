...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="f6776-103">Usar filtros de Hub en ASP.NET Core :::no-loc(SignalR):::</span><span class="sxs-lookup"><span data-stu-id="f6776-103">Use hub filters in ASP.NET Core :::no-loc(SignalR):::</span></span>
