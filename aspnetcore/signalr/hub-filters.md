...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="3018f-103">Usar filtros de Hub en ASP.NET Core SignalR</span><span class="sxs-lookup"><span data-stu-id="3018f-103">Use hub filters in ASP.NET Core SignalR</span></span>
