...
### <a name="no-locsignalr-server-metrics"></a><span data-ttu-id="c725f-232">:::no-loc(SignalR)::: métricas de servidor</span><span class="sxs-lookup"><span data-stu-id="c725f-232">:::no-loc(SignalR)::: server metrics</span></span>
