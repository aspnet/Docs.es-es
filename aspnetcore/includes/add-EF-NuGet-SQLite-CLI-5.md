<span data-ttu-id="f256c-101">Ejecute los siguientes comandos de la CLI de .NET:</span><span class="sxs-lookup"><span data-stu-id="f256c-101">Run the following .NET CLI commands:</span></span>
