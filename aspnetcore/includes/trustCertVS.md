<span data-ttu-id="462cd-101">Visual Studio muestra el cuadro de diálogo siguiente:</span><span class="sxs-lookup"><span data-stu-id="462cd-101">Visual Studio displays the following dialog:</span></span>
