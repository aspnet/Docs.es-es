<span data-ttu-id="2ca16-101">Ejecute los siguientes comandos CLI de .NET Core:</span><span class="sxs-lookup"><span data-stu-id="2ca16-101">Run the following .NET Core CLI commands:</span></span>
