<span data-ttu-id="f74d1-101">El componente `FetchData` muestra:</span><span class="sxs-lookup"><span data-stu-id="f74d1-101">The `FetchData` component shows how to:</span></span>
