...
### <a name="model-responsibilities"></a><span data-ttu-id="0b28d-122">Responsabilidades del modelo</span><span class="sxs-lookup"><span data-stu-id="0b28d-122">Model Responsibilities</span></span>
...
* [<span data-ttu-id="0b28d-153">Razor motor de vista</span><span class="sxs-lookup"><span data-stu-id="0b28d-153">Razor view engine</span></span>](#razor-view-engine)
...
* [<span data-ttu-id="0b28d-156">Ver componentes</span><span class="sxs-lookup"><span data-stu-id="0b28d-156">View Components</span></span>](#view-components)
...
### <a name="model-binding"></a><span data-ttu-id="0b28d-165">Enlace de modelos</span><span class="sxs-lookup"><span data-stu-id="0b28d-165">Model binding</span></span>
...
### <a name="filters"></a><span data-ttu-id="0b28d-178">Filtros</span><span class="sxs-lookup"><span data-stu-id="0b28d-178">Filters</span></span>
...
### <a name="web-apis"></a><span data-ttu-id="0b28d-190">API web</span><span class="sxs-lookup"><span data-stu-id="0b28d-190">Web APIs</span></span>
...
### <a name="no-locrazor-view-engine"></a><span data-ttu-id="0b28d-200">Razor motor de vista</span><span class="sxs-lookup"><span data-stu-id="0b28d-200">Razor view engine</span></span>

<span data-ttu-id="0b28d-201">[ASP.net Core vistas de MVC](views/overview.md) usan el [ Razor motor de vistas](views/razor.md) para representar las vistas.</span><span class="sxs-lookup"><span data-stu-id="0b28d-201">[ASP.NET Core MVC views](views/overview.md) use the [Razor view engine](views/razor.md) to render views.</span></span> <span data-ttu-id="0b28d-202">Razor es un lenguaje de marcado de plantilla compacto, expresivo y fluido para definir vistas mediante código C# incrustado.</span><span class="sxs-lookup"><span data-stu-id="0b28d-202">Razor is a compact, expressive and fluid template markup language for defining views using embedded C# code.</span></span> <span data-ttu-id="0b28d-203">Razor se utiliza para generar dinámicamente contenido web en el servidor.</span><span class="sxs-lookup"><span data-stu-id="0b28d-203">Razor is used to dynamically generate web content on the server.</span></span> <span data-ttu-id="0b28d-204">Permite combinar de manera limpia el código del servidor con el código y el contenido del lado cliente.</span><span class="sxs-lookup"><span data-stu-id="0b28d-204">You can cleanly mix server code with client side content and code.</span></span>
