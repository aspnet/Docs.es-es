...
<span data-ttu-id="f58ac-121">Si utiliza Razor páginas, vea [áreas con Razor páginas](#areas-with-razor-pages) en este documento.</span><span class="sxs-lookup"><span data-stu-id="f58ac-121">If you're using Razor Pages, see [Areas with Razor Pages](#areas-with-razor-pages) in this document.</span></span>
...
### <a name="_viewimportscshtml"></a><span data-ttu-id="f58ac-179">_ViewImports.cshtml</span><span class="sxs-lookup"><span data-stu-id="f58ac-179">_ViewImports.cshtml</span></span>
 ...
 <span data-ttu-id="f58ac-180">*/Views/_ViewImports. cshtml* , para MVC y */pages/_ViewImports. cshtml* para Razor páginas, no se importa a las vistas de las áreas.</span><span class="sxs-lookup"><span data-stu-id="f58ac-180">*/Views/_ViewImports.cshtml* , for MVC, and */Pages/_ViewImports.cshtml* for Razor Pages, is not imported to views in areas.</span></span> <span data-ttu-id="f58ac-181">Use uno de los métodos siguientes para proporcionar las importaciones de vistas a todas las vistas:</span><span class="sxs-lookup"><span data-stu-id="f58ac-181">Use one of the following approaches to provide view imports to all views:</span></span>
...
## <a name="areas-with-no-locrazor-pages"></a><span data-ttu-id="f58ac-189">Áreas con Razor páginas</span><span class="sxs-lookup"><span data-stu-id="f58ac-189">Areas with Razor Pages</span></span>

<span data-ttu-id="f58ac-190">Las áreas con Razor páginas requieren una `Areas/<area name>/Pages` carpeta en la raíz de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="f58ac-190">Areas with Razor Pages require an `Areas/<area name>/Pages` folder in the root of the app.</span></span> <span data-ttu-id="f58ac-191">La siguiente estructura de carpetas se usa con la [aplicación de ejemplo](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/31samples):</span><span class="sxs-lookup"><span data-stu-id="f58ac-191">The following folder structure is used with the [sample app](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/31samples):</span></span>
...
### <a name="link-generation-with-no-locrazor-pages-and-areas"></a><span data-ttu-id="f58ac-204">Generación de vínculos con Razor páginas y áreas</span><span class="sxs-lookup"><span data-stu-id="f58ac-204">Link generation with Razor Pages and areas</span></span>
...
<span data-ttu-id="f58ac-219">Se puede Agregar un archivo *_ViewImports. cshtml* a cada carpeta de *páginas* de área para importar las aplicaciones auxiliares de espacio de nombres y etiquetas a cada Razor Página de la carpeta.</span><span class="sxs-lookup"><span data-stu-id="f58ac-219">A *_ViewImports.cshtml* file can be added to each area *Pages* folder to import the namespace and Tag Helpers to each Razor Page in the folder.</span></span>

<span data-ttu-id="f58ac-220">Tenga en cuenta el área *Services* del código de ejemplo, que no contiene un archivo *_ViewImports.cshtml* .</span><span class="sxs-lookup"><span data-stu-id="f58ac-220">Consider the *Services* area of the sample code, which doesn't contain a *_ViewImports.cshtml* file.</span></span> <span data-ttu-id="f58ac-221">En el marcado siguiente se muestra la página */Services/Manage/about* Razor :</span><span class="sxs-lookup"><span data-stu-id="f58ac-221">The following markup shows the */Services/Manage/About* Razor Page:</span></span>
...
<span data-ttu-id="f58ac-226">En el marcado siguiente se muestra la página */Products/about* Razor :</span><span class="sxs-lookup"><span data-stu-id="f58ac-226">The following markup shows the */Products/About* Razor Page:</span></span>
...
### <a name="shared-layout-for-no-locrazor-pages-areas"></a><span data-ttu-id="f58ac-229">Diseño compartido para Razor áreas de páginas</span><span class="sxs-lookup"><span data-stu-id="f58ac-229">Shared layout for Razor Pages Areas</span></span>
...
<span data-ttu-id="f58ac-247">Si utiliza Razor páginas, vea [áreas con Razor páginas](#areas-with-razor-pages) en este documento.</span><span class="sxs-lookup"><span data-stu-id="f58ac-247">If you're using Razor Pages, see [Areas with Razor Pages](#areas-with-razor-pages) in this document.</span></span>
...
## <a name="areas-with-no-locrazor-pages"></a><span data-ttu-id="f58ac-306">Áreas con Razor páginas</span><span class="sxs-lookup"><span data-stu-id="f58ac-306">Areas with Razor Pages</span></span>

<span data-ttu-id="f58ac-307">Las áreas con Razor páginas requieren una `Areas/<area name>/Pages` carpeta en la raíz de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="f58ac-307">Areas with Razor Pages require an `Areas/<area name>/Pages` folder in the root of the app.</span></span> <span data-ttu-id="f58ac-308">La siguiente estructura de carpetas se usa con la [aplicación de ejemplo](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/samples):</span><span class="sxs-lookup"><span data-stu-id="f58ac-308">The following folder structure is used with the [sample app](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/samples):</span></span>
...
### <a name="link-generation-with-no-locrazor-pages-and-areas"></a><span data-ttu-id="f58ac-321">Generación de vínculos con Razor páginas y áreas</span><span class="sxs-lookup"><span data-stu-id="f58ac-321">Link generation with Razor Pages and areas</span></span>
...
<span data-ttu-id="f58ac-337">Se puede Agregar un archivo *_ViewImports. cshtml* a cada carpeta de *páginas* de área para importar las aplicaciones auxiliares de espacio de nombres y etiquetas a cada Razor Página de la carpeta.</span><span class="sxs-lookup"><span data-stu-id="f58ac-337">A *_ViewImports.cshtml* file can be added to each area *Pages* folder to import the namespace and Tag Helpers to each Razor Page in the folder.</span></span>

<span data-ttu-id="f58ac-338">Tenga en cuenta el área *Services* del código de ejemplo, que no contiene un archivo *_ViewImports.cshtml* .</span><span class="sxs-lookup"><span data-stu-id="f58ac-338">Consider the *Services* area of the sample code, which doesn't contain a *_ViewImports.cshtml* file.</span></span> <span data-ttu-id="f58ac-339">En el marcado siguiente se muestra la página */Services/Manage/about* Razor :</span><span class="sxs-lookup"><span data-stu-id="f58ac-339">The following markup shows the */Services/Manage/About* Razor Page:</span></span>
...
<span data-ttu-id="f58ac-344">En el marcado siguiente se muestra la página */Products/about* Razor :</span><span class="sxs-lookup"><span data-stu-id="f58ac-344">The following markup shows the */Products/About* Razor Page:</span></span>
...
### <a name="shared-layout-for-no-locrazor-pages-areas"></a><span data-ttu-id="f58ac-347">Diseño compartido para Razor áreas de páginas</span><span class="sxs-lookup"><span data-stu-id="f58ac-347">Shared layout for Razor Pages Areas</span></span>
